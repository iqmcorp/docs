...
The Trade Desk refers to their conversions as tracking tags. They use two types of conversions, similar to IQM. Their HTML conversion is called a "static tag" rather than IQM's "pixel"; their server-to-server conversion is a "universal pixel tag" rather than IQM's "postback". This page foregrounds IQM's usage. 
