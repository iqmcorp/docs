...
<tr>
  ...
  <td>An active PG deal (`pgDealId`) is required to create a Campaign. <p />Refer to [Migrate an Inventory](/docs/Tutorials/Trade%20Desk%20Migration/Inventories-Migration-Guide) page for more details.</td>
</tr>
<tr>
