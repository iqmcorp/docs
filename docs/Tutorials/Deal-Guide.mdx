...
To create a deal you will need an account on the IQM Platform (see [Getting Started](/Getting%20Started/Before-You-Begin)). Once you have an account you can log in and request the Exchange list.
...
Once an exchange is selected, use the <var>exchangeId</var> from the response to create a PMP deal. 
