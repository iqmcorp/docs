...
| `appIds`<br /><span class="type-text">string</span> | Comma separated [Application ID](/Guidelines/Workspace-Guidelines#application-ids) to add or revoke Customer access to |
