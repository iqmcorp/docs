...
Customer can be invited or signed up to the IQM platform as Workspaces or Advertisers. 
  ...
  * **Advertisers** are individually managed and may have limited permissions or app access. Inserition Orders and Campaigns are created at the Advertiser level. 
...
Once a Customer has accepted their invitation and onboarding is complete other actions can be performed. This Tutorial will cover a few examples. The rest of the possible Customer actions are documented in the [Workspace API](/Guidelines/Workspace-Guidelines). 
