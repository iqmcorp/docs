...
Learn more about the planner and proposals with our [Help Center<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="1em" height="1.2em" stroke-width="1.5"><path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6"></path><path d="M11 13l9 -9"></path><path d="M15 4h5v5"></path></svg>](https://help.iqm.com/en/articles/10104696-planner-proposal-overview) articles. 
...
<td colSpan="2">
  ...
  <tr>
    ...
    <td>[Country ID](/docs/Guidelines/Master-API-Guidelines#get-country-segment)</td>
  </tr>
    <tr>
    <td>`states`<br /><span class="type-text">array of integers</span></td>
    <td>[States ID](/docs/Guidelines/Master-API-Guidelines#get-state-segment)</td>
  </tr>
  <tr>
    <td>`dma`<br /><span class="type-text">array of integers</span></td>
    <td>[DMA ID](/docs/Guidelines/Master-API-Guidelines#get-dma-code-segment)</td>
  </tr>
  <tr>
    <td>`city`<br /><span class="type-text">array of integers</span></td>
    <td>[City ID](/docs/Guidelines/Master-API-Guidelines#get-city-segment)</td>
  </tr>
  <tr>
    <td>`county`<br /><span class="type-text">array of integers</span></td>
    <td>[County ID](/docs/Guidelines/Master-API-Guidelines#get-county-segment)</td>
  </tr>
  <tr>
    <td>`congressionalDistricts`<br /><span class="type-text">array of integers</span></td>
    <td>[Congressional district ID](/docs/Guidelines/Master-API-Guidelines#get-congressional-district-segment)</td>
  </tr>
  <tr>
    <td>`stateHouse`<br /><span class="type-text">array of integers</span></td>
    <td>[State house ID](/docs/Guidelines/Master-API-Guidelines#get-house-district-segment)</td>
  </tr>
  <tr>
    <td>`stateSenate`<br /><span class="type-text">array of integers</span></td>
    <td>[State senate ID](/docs/Guidelines/Master-API-Guidelines#get-senate-district-segment)</td>
  </tr>
  <tr>
    <td>`zipCodes`<br /><span class="type-text">string</span></td>
    <td>Comma separated [Zip Code IDs](/docs/Guidelines/Master-API-Guidelines#get-zip-codes-and-state-ids)</td>
  </tr>
  </table></details>
  </td>
  <td></td>
...
<td colSpan="2">
  ...
  <tr>
    ...
    <td>[Creative type ID](/docs/Guidelines/Master-API-Guidelines#get-zip-codes-and-state-ids)</td>
  </tr>
  </table></details>
  </td>
</tr>
...
<td colSpan="2">
  ...
  <tr>
    <td colSpan="2">
      ...
      <tr>
        ...
        <td>[IAB category ID](/docs/Guidelines/Master-API-Guidelines#get-publisher-ad-categories)</td>
      </tr>
      <tr>
        <td>`exchanges`<br /><span class="type-text">array of integers</span></td>
        <td>[Exchange ID](/docs/Guidelines/Master-API-Guidelines#get-exchanges)</td>
      </tr>
      </table></details>
      </td>
  </tr>
  <tr>
    ...
    <td>[Inventory group ID](/docs/Guidelines/Master-API-Guidelines#get-inventory)</td>
  </tr>
  </table></details>
  </td>
</tr>
...
<td colSpan="2">
  ...
  <tr>
    ...
    <td>Targeted [Device Type IDs](/docs/Guidelines/Master-API-Guidelines#get-device-type)</td>
  </tr>
   <tr>
    <td>`channelTypesTargetedIds`<br /><span class="type-text">array of integers</span></td>
    <td>Targeted [Channel Type IDs](/docs/Guidelines/Master-API-Guidelines#get-channels-for-inventory)</td>
  </tr>
  </table></details>
  </td>
</tr>
...
<td colSpan="2">
  ...
  <tr>
    ...
    <td>When `true`, indicates that a new Campaign must be created for advanced audience and inventory targeting</td>
  </tr>
    <tr>
    <td>`locationAdvanceTargeted` <br /><span class="type-text">array of integers</span></td>
    <td>When `true`, indicates that a new Campaign must be created for advanced location targeting</td>
  </tr>
  </table></details>
  </td>
  <td></td>
...
<td colSpan="2">
  ...
  <tr>
    <td>`creativeTypeIds`<br /><span class="type-text">array of integers</span></td>
    <td>[Creative type ID](/docs/Guidelines/Master-API-Guidelines#get-creative-types)</td>
  </tr>
  <tr>
    <td>`isTvAutoBuying` <br /><span class="type-text">boolean</span></td>
    <td>If `true`, indicates video Creative is eligible for TV Advertising</td>
  </tr>
  </table></details>
  </td>
</tr>
...
<td colSpan="2">
  ...
  <tr>
    ...
    <td>When `true`, indicates that a new Campaign must be created for advanced device targeting</td>
  </tr>
  </table></details>
  </td>
</tr>
