...
Manage Bid Modeling configurations for Campaigns with <var>ADD</var>, <var>UPDATE</var>, and <var>DELETE</var> operations on Bid Modeling attributes. 
    ...
    <td colSpan="2">
      ...
      <td>Object containing Bid Model entity details, for <var>ADD</var> and <var>UPDATE</var> operations </td>
       ...
       <tr>
        ...
        <td>Array of Bid Model data IDs for <var>DELETE</var> operation</td>
       </tr>
        <tr>
