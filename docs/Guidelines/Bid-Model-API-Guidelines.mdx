...
Learn more about Bid Modeling with our [Help Center<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="1em" height="1.2em" stroke-width="1.5"><path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6"></path><path d="M11 13l9 -9"></path><path d="M15 4h5v5"></path></svg>](https://help.iqm.com/en/collections/3156335-set-a-bid-model) article. 
...
Get details on total and dimension specific counts of modeled items for a specified Campaign.
...
| Query Parameters | |
| --- | --- |
| `dimensionIds` <br /><span class="type-text">string</span> | Comma separated dimension IDs to delete bid modeling data for |
| `bidModelDataIds` <br /><span class="type-text">string</span> | Comma separated bid model data IDs to delete |
| `campaignId` <br /><span class="type-text">string</span> | Campaign ID to delete bid modeling data for |
...
<td> Sorts by ascending (`+`) or descending (`-`) <br />Default: `-impressions`</td>
</tr>
<tr>
<td>`pageNo` <br /><span class="type-text">integer</span></td>
<td>Page number for the data <br />Default: `1`</td>
</tr>
<tr>
<td>`pageSize` <br /><span class="type-text">integer</span></td>
<td>Maximum number of results returned <br />Default: `50`</td>
</tr>
<tr>
