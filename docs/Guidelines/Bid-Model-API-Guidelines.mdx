...
export interface paths {
  "/api/v3/bm/campaigns/{campaignId}/dimensions/count": {
    get: operations["getDimensionWiseServeCount"]
  }
}


export interface operations {
 getDimensionWiseServeCount: {
    parameters: {
      query: {
        startDate: number;
        endDate: number;
...
```ts
export interface paths {
  "/api/v3/bm/campaigns/{campaignId}/dimension/{dimensionId}/spent": {
    get: operations["getDimensionWiseEntitySpentForCampaign"];
  };
}

export interface operations {
  getDimensionWiseEntitySpentForCampaign: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/bm/campaigns/{campaignId}/bid-models/count": {
    get: operations["getModelledItemsCount"];
  };
}

export interface operations {
  getModelledItemsCount: {
    parameters: {
      query?: {
        dimensionId?: number;
      };
...
```ts
export interface paths {
  "/api/v2/cmp/deviceType/includeExclude": {
    post: operations["DeviceType-includeExclude"];
  }
/**
 * Substitute exchange or trafficsource endpoints
 * @example {
 * 
 *  "/api/v2/cmp/exchange/includeExclude": {
 *    post: operations["Exchange-includeExclude"];
 *  }
 *
 *  or
 *
 * "/api/v2/cmp/trafficsource/includeExclude": {
 *    post: operations["Trafficsource-includeExclude"];
 *  };
 *}
 */
}
...
```ts
export interface paths {
  "/api/v3/bm/campaigns/{campaignId}/include-exclude/dimensions/{dimensionId}": {
    post: operations["toggleCampaignDimensionStatus"];
  };
}

export interface operations {
 toggleCampaignDimensionStatus: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
export interface paths {
  "/api/v3/bm/io/{ioId}/bid-models": {
    put: operations["managePriorityToCampaign"];
  }
}

export interface operations {
  managePriorityToCampaign: {
    parameters: {
      header?: {
        "X-IAA-OW-ID"?: string;
        Authorization?: string;
...
export interface paths {
 "/api/v3/bm/io/{ioId}/bid-models": {
    post: operations["addPriorityToCampaign"];
    delete: operations["deletePriorityToCampaign"];
    patch: operations["updatePriorityToCampaign"];
  };
}

export interface operations {
  addPriorityToCampaign: {
    parameters: {
      header?: {
        "X-IAA-OW-ID"?: string;
        Authorization?: string;
...
export interface paths {
  "/api/v3/bm/campaigns/{campaignId}/bid-models": {
    post: operations["addBidModellingOfDimensionForCampaign"];
  };
}

export interface operations {
  addBidModellingOfDimensionForCampaign: {
    parameters: {
      header?: {
        "X-IAA-OW-ID"?: string;
        Authorization?: string;
...
export interface paths {
  "/api/v3/bm/campaigns/{campaignId}/bid-models": {
    parameters: {};
    put: operations["manageBidModelling"];
  };
}
...
export interface paths {
 "/api/v3/bm/campaigns/{campaignId}/bid-models": {
    parameters: {};
    patch: operations["updateBidModellingForCampaign"];
  };
}

export interface operations {
  updateBidModellingForCampaign: {
    parameters: {
      header?: {
        "X-IAA-OW-ID"?: string;
        Authorization?: string;
...
export interface paths {
  "/api/v3/bm/campaigns/{campaignId}/bid-models": {
    parameters: {};
    delete: operations["deleteBidModelling"];
  };
}
...
```ts
export interface paths {
  "/api/v3/bm/campaigns/{campaignId}/reports/{dimensionId}": {
    post: operations["fetchCampaignMetricsByDimension"];
  };
}

export interface operations {
  fetchCampaignMetricsByDimension: {
    parameters: {
      query?: {
        searchField?: string;
        sortBy?: string;
