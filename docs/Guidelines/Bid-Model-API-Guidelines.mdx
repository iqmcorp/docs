...
<tr>
  <td>`creative` <br /><span class="type-text">integer</span></td>
  <td>Creative Dimension count</td>
</tr>
<tr>
  <td>`dealId` <br /><span class="type-text">integer</span></td>
  <td>Deal Dimension count</td>
</tr>
<tr>
  <td>`openExchange` <br /><span class="type-text">integer</span></td>
  <td>Open Exchange Dimension count</td>
</tr>
<tr>
  <td>`publisherCategory` <br /><span class="type-text">integer</span></td>
  <td>Publisher Category Dimension count</td>
</tr>
<tr>
  <td>`trafficType` <br /><span class="type-text">integer</span></td>
  <td>Traffic Type Dimension Count</td>
</tr>
<tr>
  <td>`deviceType` <br /><span class="type-text">integer</span></td>
  <td>Device Type Dimension count</td>
</tr>
<tr>
  <td>`state` <br /><span class="type-text">integer</span></td>
  <td>State Dimension count</td>
</tr>
<tr>
  <td>`city` <br /><span class="type-text">integer</span></td>
  <td>City Dimension count</td>
</tr>
<tr>
  <td>`zip` <br /><span class="type-text">integer</span></td>
  <td>Zip Code Dimension count</td>
</tr>
<tr>
  <td>`exchange` <br /><span class="type-text">integer</span></td>
  <td>Exchange Dimension count</td>
</tr>
</table></details>
...
<tr>
  ...
  <td>Total count of modeled items for a Campaign</td>
</tr>
<tr>
  <td>`dimensionWiseCount` <br /><span class="type-text">object</span></td>
  <td>Dimension specific count of modeled items for a Campaign</td>
</tr>
<tr>
<td colSpan="2">
  <details className="objectPropertiesDetails">
  <summary>`dimensionWiseCount` object properties</summary>
  <table className="objectProperties">
  <tr>
  ...
  <td>[Dimension ID](#get-list-of-bid-model-dimensions)</td>
    ...
    <tr>
  <td>`count`<br /><span class="type-text">object</span></td>
  <td>Modeled items count</td>
  </tr>
  </table></details>
  </td>
  <td></td>
