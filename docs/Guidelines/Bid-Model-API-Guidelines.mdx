...
The Bid Model API allows users to optimize their advertising Campaigns for better performance. The user can fine-tune metrics such as where their ads appear (Include/Exclude), manage Campaign priority, and dimensions by which a Campaign is subdivided.

This page covers the common endpoints and methods associated with the Bid Model API.

Learn more about Bid Modelling with our [Help Center article<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1.1em" viewBox="0 0 21 21"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.5 8.5v-5h-5m5 0l-7 7m-1-7h-5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-4"/></svg>](https://help.iqm.com/en/collections/3156335-set-a-bid-model). 
