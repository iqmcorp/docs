...
| <div class="border">`bidModelDataIds` <br /><span class="type-text">array of integers</span></div> | Bid Model data IDs
...
| attributes | |
| --- | --- |
| `id` <br /><span class="type-text">integer</span> | Bid Model data ID 
