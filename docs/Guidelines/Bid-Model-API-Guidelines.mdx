...
| Path Parameters     |  |
| ---- | --- |
| `campaignId` <br /><span class="type-text">integer</span>  | The Campaign ID |
| `dimensionId` <br /><span class="type-text">integer</span> | Dimension ID <br />See static [List of Dimension IDs](#get-list-of-bid-model-dimensions) |
