      ...
      <td>Object containing Bid Model Data properties</td>
       ...
       <tr>
          <td colSpan="2">
              ...
              <td>Spend ratio type ID<br /> [ <var>1</var> , <var>2</var> ]</td>
              </tr>
              </table></details>
            </td>
            <td></td>
...
Assigning priority to Campaigns allows the user to establish a sequential order of bidding to fine-tune their targeting strategy. Assign priority (ranging 1 to 10) to multiple <var>campaignIds</var>.
