...
export interface paths {
  "/api/v3/ins/insights/list": {
    parameters: {};
    get: operations["getInsightsDetailList"];
  };
}

export interface operations {
  getInsightsDetailList: {
    parameters: {
      query?: {
        searchField?: string;
        pageSize?: number;
...
export interface paths {
  "/api/v3/ins/campaign/bid-insights/{campaignId}": {
    parameters: {};
    get: operations["getCampaignBiddingInsight"];
  };
}

export interface operations {
  getCampaignBiddingInsight: {
    parameters: {
      query: {
...
```ts
export interface paths {
  "/api/v3/ins/audiences/list": {
    parameters: {};
    get: operations["getInsightsCreateEligibleAudienceList"];
  };
}

export interface operations {
  getInsightsCreateEligibleAudienceList: {
    parameters: {
      query?: {
        searchField?: string;
        pageSize?: number;
...
```ts
export interface paths {
  "/api/v3/ins/insights/type-wise-count": {
    parameters: {};
    get: operations["getInsightsTypeWiseCount"];
  };
}

export interface operations {
  getInsightsTypeWiseCount: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/ins/audience/matched/{audienceId}": {
    parameters: {};
    get: operations["getMatchedAudienceDetailsByAudienceId"];
  };
}

export interface operations {
  getMatchedAudienceDetailsByAudienceId: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/ins/audience/matched/download/{audienceId}": {
    parameters: {};
    get: operations["downloadMatchedAudienceFile"];
  };
}

export interface operations {
  downloadMatchedAudienceFile: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
export interface paths {
  "/api/v3/ins/insights/add": {
    parameters: {};
    post: operations["createInsightsDetails"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ins/insights/delete": {
    parameters: {};
    delete: operations["deleteInsights"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ins/insights/regenerate/{insightsId}": {
    parameters: {};
    post: operations["regenerateInsights_1"];
  };
}

export interface operations {
  regenerateInsights_1: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
export interface paths {
  "/api/v3/ins/insights/download": {
    parameters: {};
    post: operations["downloadInsights"];
  };
}
...
```ts
export interface paths {
 "/api/v3/ins/send-email": {
    parameters: {};
    post: operations["sendInsightsEmail"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ins/vld-reports": {
    parameters: {};
    get: operations["getVLDReportList"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ins/vld/campaigns": {
    parameters: {};
    get: operations["getStatusWiseCampaignsForVLDReports"];
  };
}

export interface operations {
  getStatusWiseCampaignsForVLDReports: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
export interface paths {
  "/api/v3/ins/vld-report": {
    parameters: {};
    post: operations["generateVLDReports"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ins/vld-reports/computation": {
    parameters: {};
    post: operations["getChargeableImpressionsDataForVLDReports"];
  };
}

export interface operations {
  getChargeableImpressionsDataForVLDReports: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
export interface paths {
  "/api/v3/ins/vld-report/download": {
    parameters: {};
    post: operations["getVLDReportDownloadUrl"];
  };
}

export interface operations {
  getVLDReportDownloadUrl: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
export interface paths {
  "/api/v3/ins/vld-report": {
    parameters: {};
    delete: operations["deleteFailedVLDReport"];
  };
}

export interface operations {
  deleteFailedVLDReport: {
    parameters: {
      query: {
        vldIds: string;
      };
...
```ts
export interface paths {
  "/api/v3/ins/static/insights/type/list": {
    parameters: {};
    get: operations["getInsightsType"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ins/static/insights/status/list": {
    parameters: {};
