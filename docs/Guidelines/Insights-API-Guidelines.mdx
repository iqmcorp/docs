...
Your Campaign must meet certain eligibility requirements before you can generate Insights Reports for it. Refer to the following Help Center articles for more information on the data included in each Report and review their individual eligibility criteria:

  * [Audience Insights Report Overview<ExternalLink />](https://help.iqm.com/en/articles/8337863-audience-insights-report-overview#h_b5765ae4d3) 
  * [Voter Level Data (VLD) Insights Report Overview<ExternalLink />](https://help.iqm.com/en/articles/9827089-voter-level-data-vld-insights-report-overview#h_f7f335080d) 
  * [Campaign Bidding Insights Report Overview<ExternalLink />](https://help.iqm.com/en/articles/10111445-campaign-bidding-insights-overview#h_3952d00349) 

:::
</div>

Learn more about Audience and VLD Insights with our [Help Center<ExternalLink />](https://help.iqm.com/en/collections/1361396-reporting-and-analytics) articles. 
...
## Practitioner Level Data Reports
...
This API calculates the cost for the impressions for the Practitioner Level Data Reports based on the impressions and mark up charged on the Organization and then creates the PLD Reports.
...
| `pldId` <br /><span class="type-text">integer</span> | Practitioner Level Data Report ID
