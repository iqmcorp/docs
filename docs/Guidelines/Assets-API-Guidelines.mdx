...
<details className="objectPropertiesDetails" style={{ maxWidth: "800px", padding: "1rem" }}>
  <summary style={{ fontSize: "16px" }}>Parameters</summary>
...
Content-Disposition: form-data; name="files"; filename="7b514f17-0606-43ee-8f8a-d33e3787f3fc~example.jpg"
Content-Type: image/jpeg

------WebKitFormBoundaryAofpaWXja6BTaYQ9
Content-Disposition: form-data; name="filesMetadata"

[{"attachedFileName":"7b514f17-0606-43ee-8f8a-d33e3787f3fc~example.jpg","originalFileName":"example.jpg"}]
------WebKitFormBoundaryAofpaWXja6BTaYQ9--
```
