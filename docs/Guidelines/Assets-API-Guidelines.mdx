...
| Query Parameters | |
| --- | --- |
| `filesMetaData` <br /><span class="type-text">string</span> <span class="required-text">required</span> | JSON string representing the metadata associated with the files |
