...
The Assets API allows users to add assets to the system such as images and PDF files.  
...
| `disposable` <br /><span class="type-text">boolean</span> | Indicates whether asset is temporary and can be purged (`true`), default: `true` |
