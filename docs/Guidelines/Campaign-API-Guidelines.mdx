...
<details className="objectPropertiesDetails" style={{ maxWidth: "100%", padding: "1rem"}}>
    ...
    <tr>
    <td>`exchanges` <br /><span class="type-text">string</span> <span class="required-text">optional</span></td>
    <td>Comma separated [Exchanges IDs](/Guidelines/Master-API-Guidelines#get-exchanges) for targeting </td>
    </tr>
    <tr>
    ...
    <td>Comma separated [Device Type IDs](/Guidelines/Master-API-Guidelines#get-device-type) for targeting </td>
        ...
        <tr>
    <td>`publisherAdCategory` <br /><span class="type-text">string</span> <span class="required-text">optional</span></td>
    <td>Comma separated [Publisher Ad Category IDs](/Guidelines/Master-API-Guidelines#get-publisher-ad-categories) for targeting </td>
    </tr>
        <tr>
...
<span class="badge badge--success">POST</span> <span class="path-text">/api/v2/cmp/inventorygroups/\{group_id}/includeexclude</span>
<br /><span class="badge badge--success">POST</span> <span class="path-text">/api/v3/cmp/inventorygroups/\{groupId}/includeExclude</span>
...
| Path Parameter | |
| --- | --- |
| `group_id` <br /><span class="type-text">integer</span> | Inventory Group ID |
| `groupId` <br /><span class="type-text">integer</span> | Inventory Group ID |

| Request Schema (v2) | |
| --- | --- |
| `campaignIds` <br /><span class="type-text">array of integers</span> | Campaign IDs for targeting 
| `isExcluded` <br /><span class="type-text">boolean</span> | Include in Campaign: <var>0</var><br /> Exclude from Campaign: <var>1</var>
...
function Inventorygrouptargeting(): Promise<Responses> {
  const options = {
    method: 'POST',
    url: 'https://app.iqm.com/api/v2/cmp/inventorygroup/{group_id}/includeExclude',
    requestBody: {
      content: {
        "application/json": {
          campaignIds: `array of numbers`,
