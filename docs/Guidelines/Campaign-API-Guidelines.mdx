...
Reference the [IO Resource Properties](#insertion-order-resource-properties) above for the value descriptions. Minimum <span class="required-text">required</span> values:
