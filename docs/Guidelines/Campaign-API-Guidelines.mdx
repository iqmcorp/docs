...
```ts
export interface paths {
  "/api/v2/cmp/campaigns/data": {
    get: operations["Getcampaigndata"];
  };
}
...
```ts
export interface paths {
  "/api/v3/cmp/basic/list": {
    post: operations["getCampaignBasicDetailList"];
  };
}

export interface operations {
  getCampaignBasicDetailList: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/cmp/customer/campaigns/list": {
    post: operations["getCampaignDetails"];
  };
}
...
```ts
export interface paths {
  "/api/v2/cmp/campaign/budgetInfo": {
    parameters: {};
    get: operations["CampaignBudgetInfo"];
  };
}
...
```ts
export interface paths {
  "/api/v3/cmp/campaigngroup/list": {
    parameters: {};
    post: operations["getCampaignGroupList"];
  };
}
...
```ts
export interface paths {
  "/api/v3/cmp/campaign-type/count": {
    parameters: {};
    post: operations["getCampaignsCountWithCampaignType"];
  };
}

export interface operations {
  getCampaignsCountWithCampaignType: {
    parameters: {};
    requestBody: {
      content: {
        "application/json": {
...
```ts
export interface paths {
  "/api/v2/cmp/campaigns/count": {
    parameters: {};
    get: operations["CampaignCountbycreativetype"];
  };
}

export interface operations {
  CampaignCountbycreativetype: {
    parameters: {
      query: {
        sortType: string;
        creativeTypeIds: string;
...
```ts
export interface paths {
  "/api/v3/cmp/creative-types/count": {
    parameters: {};
    post: operations["getCampaignCountWithCreativeTypeByIoIds"];
  };
}

export interface operations {
  getCampaignCountWithCreativeTypeByIoIds: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v2/cmp/campaign/start": {
    parameters: {};
    get: operations["Getcampaignstartdate"];
  };
}
...
```ts
export interface paths {
  "/api/v3/cmp/startDate/list": {
    parameters: {};
    post: operations["getCampaignStartDateList"];
  };
  "/api/v3/cmp/endDate/list": {
    parameters: {};
    post: operations["getCampaignEndDateList"];
  };
}

export interface operations {
  getCampaignStartDateList: {
/**
 * or
 * 
 * getCampaignEndDateList : {
*/
    parameters: {
      header?: {
        Authorization?: string;
...
```ts
export interface paths {
  "/api/v3/cmp/campaigns/report/data": {
    parameters: {};

    get: operations["GetCampaignReportData"];
  };
}
...
export interface paths {
  ...
  "/api/v2/cmp/campaigns/draft/add": {
    parameters: {};
    post: operations["saveDraftCampaign"];
  };
}
...
```ts
export interface paths {
  "/api/v3/cmp/pg/campaigns/{campaignId}": {
    parameters: {};
    patch: operations["editPGCampaign"];
  };
  "/api/v3/cmp/pg/campaigns/draft/{campaignId}": {
    parameters: {};
    patch: operations["editDraftPGCampaign"];
  };
}
...
export interface paths {
  "/api/v2/cmp/campaign/{campaignId}": {
    parameters: {};
    patch: operations["editCampaignPatch"];
  };
}
...
```ts
export interface paths {
  "/api/v3/cmp/campaign/update-name/{campaign_id}": {
    parameters: {};
    patch: operations["UpdateCampaignName"];
  };
}
...
```ts
export interface paths {
  "/api/v2/cmp/campaigns/update-end-date": {
    parameters: {};
    put: operations["Campaignenddateupdate"];
  };
}

export interface operations {
  Campaignenddateupdate: {
    parameters: {
      header: {
        "X-IAA-OW-ID": number;
        "X-Iaa-Host": string;
...
```ts
export interface paths {
 "/api/v2/cmp/campaigns/update-budget": {
    parameters: {};
    put: operations["Campaignbudgetupdate"];
  };
}
...
```ts
export interface paths {
  "/api/v3/cmp/target/audience": {
    parameters: {};
    post: operations["CampaignAudienceTargetingList"];
  };
}

export interface operations {
  CampaignAudienceTargetingList: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
 "/api/v3/cmp/pmp/campaigns/mappings": {
    parameters: {};
    patch: operations["managePMPDealCampaignMappings"];
  };
}

export interface operations {
  managePMPDealCampaignMappings: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/cmp/pg/campaigns/mappings": {
    parameters: {};
    patch: operations["managePgDealCampaignMappings"];
  };
}

export interface operations {
  managePgDealCampaignMappings: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/cmp/io/basic/list": {
    parameters: {};
    post: operations["getIOBasicDetailsList"];
  };
}

export interface operations {
  getIOBasicDetailsList: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
export interface paths {
  "/api/v3/cmp/io/advanced/list": {
    parameters: {};
    get: operations["getIOListWithReportData"];
  };
}

export interface operations {
  getIOListWithReportData: {
    parameters: {
      query?: {
        searchField?: string;
        pageSize?: number;
...
```ts
export interface paths {
  "/api/v3/cmp/io/campaign/budget-impression/info": {
    parameters: {};
    get: operations["getBudgetAndImpressionInfoByIOId"];
  };
}

export interface operations {
  getBudgetAndImpressionInfoByIOId: {
    parameters: {
      query: {
        ioId: number;
      };
...
```ts
export interface paths {
  "/api/v3/cmp/io/campaign/basic/list": {
    parameters: {};
    post: operations["getIoMappedWithCampaignsDetails"];
  };
}

export interface operations {
  getIoMappedWithCampaignsDetails: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/cmp/io/campaign/served/list": {
    parameters: {};
    post: operations["getServedIoMappedWithCampaignsDetails"];
  };
}

export interface operations {
  getServedIoMappedWithCampaignsDetails: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/cmp/io/campaigns/list": {
    parameters: {};
    post: operations["getCampaignIODetailsByIoId"];
  };
}

export interface operations {
  getCampaignIODetailsByIoId: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/cmp/io/campaigns/list/download": {
    parameters: {};
    post: operations["downloadCampaignsReport"];
  };
}

export interface operations {
  downloadCampaignsReport: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/cmp/io/startDate/list": {
    parameters: {};
    post: operations["getIOStartDateList"];
  };
  "/api/v3/cmp/io/endDate/list": {
    parameters: {};
    post: operations["getIOEndDateList"];
  };
}
...
export interface paths {
  "/api/v3/cmp/io/{ioId}": {
    parameters: {};
    patch: operations["editIODetails"];
  };
}
...
```ts
export interface paths {
  "/api/v3/cmp/io/update-end-date": {
    parameters: {};
    patch: operations["updateIOEndDate"];
  };
}
...
```ts
export interface paths {
  "/api/v3/cmp/io/update-budget": {
    parameters: {};
    patch: operations["updateIOBudgetByIOList"];
  };
}

export interface operations {
  updateIOBudgetByIOList: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/cmp/io/duplicate": {
    parameters: {};
    post: operations["duplicateIO"];
  };
}
...
```ts
export interface paths {
 "/api/v3/cmp/io/delete": {
    parameters: {};
    post: operations["updateIOStatusToDelete"];
  };
}

export interface operations {
  updateIOStatusToDelete: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/cmp/static/io/status/list": {
    parameters: {};
    get: operations["getIOStatusTypeList"];
  };
}
...
```ts
export interface paths {
  "/api/v3/cmp/static/campaign/budget-type": {
    parameters: {};
    get: operations["getBudgetTypeList"];
  };
}
...
```ts
export interface paths {
  "/api/v3/cmp/static/budget-distribution-method/list": {
    parameters: {};
    get: operations["getStaticBudgetDistributionList"];
  };
}

export interface operations {
  getStaticBudgetDistributionList: {
    parameters: {
      query?: {
