...
Learn more about Campaigns and Insertion Orders with our [Help Center articles<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1.1em" viewBox="0 0 21 21"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.5 8.5v-5h-5m5 0l-7 7m-1-7h-5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-4"/></svg>](https://help.iqm.com/en/collections/1962110-create-a-campaign). 
...
| `isBidShading` <br /><span class="type-text">boolean</span> | Indicates whether Bid Shading is turned on (`true`) or off (`false`)
...
| `isLocationWithOrFilter` <br /><span class="type-text">boolean</span> | Indicates if the location should be applied with or filtered from the results 
...
<td colSpan="2">
  ...
  <th colspan="2" style={{ textAlign: 'center' }}>`pgCampaignInfo` Object Properties</th>
  <th></th>
  <tr>
...
<td colSpan="2">
  <table className="objectProperties">
  <th colspan="2" style={{ textAlign: 'center' }}>`creativeTargeting` Object Properties</th>
  <tr>
...
<td colSpan="2">
  <table className="objectProperties">
  <th colspan="2" style={{ textAlign: 'center' }}>`inventoryTargeting` Object Properties</th>
  <tr>
...
<td colSpan="2">
  <table className="objectProperties">
  <th colspan="2" style={{ textAlign: 'center' }}>`conversionTargeting` Object Properties</th>
  <tr>
...
| Attributes | |
| --- | --- |
| Budget <br /><span class="type-text">ID: 1</span> | Campaigns/Insertion Orders with set budget amount, [read more<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1.1em" viewBox="0 0 21 21"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.5 8.5v-5h-5m5 0l-7 7m-1-7h-5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-4"/></svg>](https://help.iqm.com/en/articles/8481053-what-is-a-budget-vs-impression-based-io) |
| Impression <br /><span class="type-text">ID: 2</span> | Campaigns/Insertion Orders with set target for impressions to generate, [read more<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1.1em" viewBox="0 0 21 21"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.5 8.5v-5h-5m5 0l-7 7m-1-7h-5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-4"/></svg>](https://help.iqm.com/en/articles/8481053-what-is-a-budget-vs-impression-based-io) |
