...
<td>Creative type ID, see [Master API](/Guidelines/Master-API-Guidelines#get-creative-types)</td>
</tr>
<tr>
...
<td>Timezone ID, see [Master API](/Guidelines/Master-API-Guidelines#get-timezones)</td>
</tr>
<tr>
...
<td>Comma separated device type IDs, see [Master API](/Guidelines/Master-API-Guidelines#get-device-type)</td>
</tr>
<tr>
<td>`trafficType` <br /><span class="type-text">string</span></td>
<td> Comma separated traffic type IDs, see [Master API](/Guidelines/Master-API-Guidelines#get-traffic-types)</td>
</tr>
<tr>
...
| `creative_type_ids` <br /><span class="type-text">integer</span> | Filter by Creative type ID, see [Master API](/Guidelines/Master-API-Guidelines#get-creative-types)  |
...
| `creativeTypeIds` <br /><span class="type-text">array of integers</span> | Filters results by provided Creative type IDs, see [Master API](/Guidelines/Master-API-Guidelines#get-creative-types)  |
...
| `creativeTypeIds` <br /><span class="type-text">array of integers</span> | Filter results by Creative type IDs, see [Master API](/Guidelines/Master-API-Guidelines#get-creative-types)  |
...
| `creativeTypeIds` <br /><span class="type-text">array of integers</span> | Filters results for Creative type IDs, see [Master API](/Guidelines/Master-API-Guidelines#get-creative-types)  |
...
| `creativeTypeIds` <br /><span class="type-text">integer</span> | Comma separated Creative type IDs, supported values: <br />Image: <var>11</var> <br />HTML: <var>13</var> <br />Video: <var>14</var> <br />Ticker Banner: <var>16</var> <br />Audio: <var>17</var> <br />GOTV: <var>18</var> (see [Master API](/Guidelines/Master-API-Guidelines#get-creative-types) ) |
...
| `isAgreementChecked` <br /><span class="type-text">boolean</span> | |
|`advertiserDomain`	<br /><span class="type-text">string</span> |	Advertiser domain
|`creativeType`	<br /><span class="type-text">integer</span> |	Creative type ID, see [Master API](/Guidelines/Master-API-Guidelines#get-creative-types) |
...
|`timezone`	<br /><span class="type-text">integer</span> |	Timezone ID for Campaign, see [Master API](/Guidelines/Master-API-Guidelines#get-timezones)
...
|`bidOptimization` <br /><span class="type-text">boolean</span> <span class="required-text">optional</span> |	Optimize bid price based on analysis: <var>true</var>
|`bidPacing` <br /><span class="type-text">boolean</span> <span class="required-text">optional</span>|	Budget is spent equally every hour: <var>true</var>
...
|`conversionType` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	User Conversion type <br/> Allowed values: <var>install</var>, <var>non-install</var> |
...
|`carriers` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated carrier IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-carriers-and-states-by-country-id)
...
|`deviceType` <br /><span class="type-text">string</span> <span class="required-text">optional</span>|	Comma separated device type IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-device-type)
|`trafficType` <br /><span class="type-text">string</span> <span class="required-text">optional</span>|	Comma separated traffic type IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-traffic-types)
|`manufacturer` <br /><span class="type-text">string</span> <span class="required-text">optional</span>|	Comma separated manufacturer IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-manufacturers-for-targeting)
|`os` <br /><span class="type-text">string</span> <span class="required-text">optional</span>|	Comma separated OS IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-device-os-for-targeting)
...
|`exchanges` <br /><span class="type-text">string</span> <span class="required-text">optional</span>|	Comma separated exchanges IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-exchanges)
|`prebidAudienceSegmentIdList` <br /><span class="type-text">array of integers</span> <span class="required-text">optional</span> |	Prebid Audience Segment IDs to attach Campaign to segment IDs
|`device` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Targeted devices as string
|`publisherAdCategory` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated publisher ad category IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-publisher-ad-categories)
...
|`stateIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated state IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-state-segment)
...
|`ageRangeIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated age range IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-age-segment)
|`genderIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated gender IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-gender-segment)
|`interestIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated interest IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-interest-segment)
|`incomeRangeIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated income range IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-income-range-segment)
|`languageIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated language IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-language-segment)
|`ethnicityIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated ethnicity IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-ethnicity-segment)
...
|`campaignIabCategoryIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Target iab categories. Value in form of a string of comma-separated ID. Only super user can update iab categories
...
|`campaignEstimatorMetaData`	<br /><span class="type-text">JSON</span> |	Campaign Estimator data with <var>reachMeta</var>, <var>landScapeMeta</var> and <var>sliderMeta</var>
...
<summary>Supported properties</summary>
...
| `technologyFlag`	<br /><span class="type-text">boolean</span> |	Technology enabled or disabled based on policy of user
|`carriers` <br /><span class="type-text">string</span> |	Comma separated carrier IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-carriers-and-states-by-country-id)
...
|`deviceType` <br /><span class="type-text">string</span> |	Comma separated device type IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-device-type)
|`trafficType` <br /><span class="type-text">string</span> |	Comma separated traffic type IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-traffic-types)
|`manufacturer` <br /><span class="type-text">string</span> |	Comma separated manufacturer IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-manufacturers-for-targeting)
|`os` <br /><span class="type-text">string</span> |	Comma separated OS IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-device-os-for-targeting)
...
|`exchanges` <br /><span class="type-text">string</span> |	Comma separated exchanges IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-exchanges)
...
|`publisherAdCategory` <br /><span class="type-text">string</span> |	Comma separated publisher ad category IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-publisher-ad-categories)
...
|`stateIds` <br /><span class="type-text">string</span> |	Comma separated state IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-state-segment)
...
|`ageRangeIds` <br /><span class="type-text">string</span> |	Comma separated age range IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-age-segment)
|`genderIds` <br /><span class="type-text">string</span> |	Comma separated gender IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-gender-segment)
|`interestIds` <br /><span class="type-text">string</span> |	Comma separated interest IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-interest-segment)
|`incomeRangeIds` <br /><span class="type-text">string</span> |	Comma separated income range IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-income-range-segment)
|`languageIds` <br /><span class="type-text">string</span> |	Comma separated language IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-language-segment)
|`ethnicityIds` <br /><span class="type-text">string</span> |	Comma separated ethnicity IDs for targeting, see [Master API](/Guidelines/Master-API-Guidelines#get-ethnicity-segment)
...
| `ioTimeZoneId` <br /><span class="type-text">integer</span> | Timezone ID, see [Master API](/Guidelines/Master-API-Guidelines#get-timezones)|
...
<tr>
  ...
  <tr>
    ...
    <tr>
    <td>`dailyCampaignDuration` <br /><span class="type-text">integer</span></td>
    <td></td>
  </tr>
  <tr>
    <td>`dailyRemainingDuration` <br /><span class="type-text">integer</span></td>
    <td></td>
  </tr>
    <tr>
...
| `creativeTypeIds` <br /><span class="type-text">array of integers</span> | Filters for Creative Type IDs, see [Master API](/Guidelines/Master-API-Guidelines#get-creative-types)  |
...
| `timeZoneId` <br /><span class="type-text">integer</span> | Filters Campaigns for specified Timezone ID, see [Master API](/Guidelines/Master-API-Guidelines#get-timezones) |
| `campaignStatusList` <br /><span class="type-text">array of strings</span> | Filters Campaigns by specified Campaign Status |
| `creativeTypeIds` <br /><span class="type-text">string</span> | Filters Campaigns by specified Creative Type ID, see [Master API](/Guidelines/Master-API-Guidelines#get-creative-types)  |
...
| `timeZoneId` <br /><span class="type-text">integer</span> | Filters data in Report for provided timezone ID, see [Master API](/Guidelines/Master-API-Guidelines#get-timezones) |
...
| Properties | |
| --- | --- |
| Budget <br /><span class="type-text">ID: 1</span> | Campaigns/Insertion Orders with set budget amount. To learn more see our [Help Center<ExternalLink />](https://help.iqm.com/en/articles/8481053-what-is-a-budget-vs-impression-based-io) articles |
| Impression <br /><span class="type-text">ID: 2</span> | Campaigns/Insertion Orders with set target for impressions to generate. To learn more see our [Help Center<ExternalLink />](https://help.iqm.com/en/articles/8481053-what-is-a-budget-vs-impression-based-io) articles |
