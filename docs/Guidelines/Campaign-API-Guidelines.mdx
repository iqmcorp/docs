...
Refer to the quickstart guide for instructions on how to [Start a New Campaign](/Quickstart%20Guides/Upload-Creative-and-Create-a-Campaign-API-Quickstart-Guide). 
...
See [`prerequisites`](/Getting%20Started/Typescript-Prerequisites.mdx) for TypeScript usage.
...
See [TypeScript Prerequisites](/Getting%20Started/Typescript-Prerequisites.mdx) page for usage.v 
