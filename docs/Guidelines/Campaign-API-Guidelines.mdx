...
<td>Budget is spent equally every hour: `true`</td>
</tr>
<tr>
<td>`isTvAd` <br /><span class="type-text">boolean</span></td>
<td>Specifies if Campaign is TV ad: `true`</td>
</tr>
<tr>
...
<td>Optimize bid price based on analysis: `true`</td>
</tr>
<tr>
...
<td>Indicates whether Bid Shading is turned on (`true`) or off (`false`)</td>
</tr>
<tr>
...
<td>`true` indicates advanced targeting is enabled</td>
</tr>
<tr>
...
| `isBasicInfo` <br /><span class="type-text">boolean</span> | If `true` returns fewer details, if `false` returns all details 
...
|`bidOptimization` <br /><span class="type-text">boolean</span> <span class="required-text">optional</span> |	Optimize bid price based on analysis: `true`
|`bidPacing` <br /><span class="type-text">boolean</span> <span class="required-text">optional</span>|	Budget is spent equally every hour: `true`
...
|`conversionType` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	User conversion type <br/> Allowed values: `install`, `non-install` |
