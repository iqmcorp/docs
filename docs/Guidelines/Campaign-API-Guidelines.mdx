...
The Campaign API allows users to create and manage Campaigns and Insertion Orders (IOs). Campaigns are targeted advertising runs that operate for a set period of time under specified optimization strategies. IOs are the parent hierarchy to Campaigns and they define the contracts between an advertiser and a media partner, as well as the parameters of an advertising Campaign. 
...
Learn more about Campaigns and Insertion Orders with our [Help Center<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign) articles. 
...
<td>Total budget for campaign</td>
</tr>
<tr>
...
<td>Comma separated device type IDs, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-device-type)</td>
</tr>
<tr>
<td>`trafficType` <br /><span class="type-text">string</span></td>
<td> Comma separated traffic type IDs, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-traffic-types)</td>
</tr>
<tr>
<td>`exchanges` <br /><span class="type-text">string</span></td>
<td>Comma separated exchange IDs</td>
</tr>
<tr>
...
<td>Comma separated state IDs</td>
</tr>
<tr>
...
<td>Comma separated Campaign iab categories</td>
</tr>
<tr>
...
| `creativeTypeIds` <br /><span class="type-text">integer</span> | Comma separated Creative type IDs, supported values: <br />Image: <var>11</var> <br />HTML: <var>13</var> <br />Video: <var>14</var> <br />Ticker Banner: <var>16</var> <br />Audio: <var>17</var> <br />GOTV: <var>18</var> (see [Master API](/docs/Guidelines/Master-API-Guidelines#get-creative-types) ) |
...
|`carriers` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated carrier IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-carriers-and-states-by-country-id)
...
|`deviceType` <br /><span class="type-text">string</span> <span class="required-text">optional</span>|	Comma separated device type IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-device-type)
|`trafficType` <br /><span class="type-text">string</span> <span class="required-text">optional</span>|	Comma separated traffic type IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-traffic-types)
|`manufacturer` <br /><span class="type-text">string</span> <span class="required-text">optional</span>|	Comma separated manufacturer IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-manufacturers-for-targeting)
|`os` <br /><span class="type-text">string</span> <span class="required-text">optional</span>|	Comma separated OS IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-device-os-for-targeting)
...
|`exchanges` <br /><span class="type-text">string</span> <span class="required-text">optional</span>|	Comma separated exchanges IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-exchanges)
...
|`publisherAdCategory` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated publisher ad category IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-publisher-ad-categories)
...
|`stateIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated state IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-state-segment)
...
|`ageRangeIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated age range IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-age-segment)
|`genderIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated gender IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-gender-segment)
|`interestIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated interest IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-interest-segment)
|`incomeRangeIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated income range IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-income-range-segment)
|`languageIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated language IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-language-segment)
|`ethnicityIds` <br /><span class="type-text">string</span> <span class="required-text">optional</span> |	Comma separated ethnicity IDs for targeting, see [Master API](/docs/Guidelines/Master-API-Guidelines#get-ethnicity-segment)
...
See [TypeScript Prerequisites](/docs/Getting%20Started/Typescript-Prerequisites.mdx) page for usage.v 
