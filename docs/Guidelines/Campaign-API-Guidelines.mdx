...
| Properties | |
| --- | --- |
| Budget <br /><span class="type-text">ID: 1</span> | Campaigns/Insertion Orders with set budget amount. To learn more see our [Help Center<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="1em" height="1.2em" stroke-width="1.5"><path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6"></path><path d="M11 13l9 -9"></path><path d="M15 4h5v5"></path></svg>](https://help.iqm.com/en/articles/8481053-what-is-a-budget-vs-impression-based-io) articles |
| Impression <br /><span class="type-text">ID: 2</span> | Campaigns/Insertion Orders with set target for impressions to generate. To learn more see our [Help Center<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="1em" height="1.2em" stroke-width="1.5"><path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6"></path><path d="M11 13l9 -9"></path><path d="M15 4h5v5"></path></svg>](https://help.iqm.com/en/articles/8481053-what-is-a-budget-vs-impression-based-io) articles |
