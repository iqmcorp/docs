...
<td>Number of Campaigns in `pending` status (see [Campaign API](/docs/Guidelines/Campaign-API-Guidelines#get-campaign-count-by-status) for more info on statuses)</td>
</tr>
<tr>
  <td>`runningCampaigns` <br /><span class="type-text">integer</span></td>
  <td>Number of Campaigns in `running` status (see [Campaign API](/docs/Guidelines/Campaign-API-Guidelines#get-campaign-count-by-status) for more info on statuses)</td>
</tr>
<tr>
...
<td>Indicates whether payment was created by logged-in organization (`true`) or not (`false`)</td>
</tr>
<tr>
...
<tr>
  ...
  <td>Bank associated with payment, if applicable, otherwise: `null`</td>
</tr>
<tr>
  <td>`refundReason` <br /><span class="type-text">string</span></td>
  <td>Reason for refund, if applicable, otherwise: `null`</td>
</tr>
</table>
...
| Query Parameter | |
| ---- | --- |
| `isWhiteLabel` <br /><span class="type-text">boolean</span> | Set by organization, must be set to `true` for invoice to be updated
