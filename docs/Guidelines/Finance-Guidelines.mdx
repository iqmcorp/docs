...
This page covers the methods and endpoints associated with finance operations. Users can access finance details and lists, and manage invoices, credit, and payment.
...
<td>Number of Campaigns in <var>pending</var> status (see [Campaign API](/docs/Guidelines/Campaign-API-Guidelines#get-campaign-count-by-status) for more info on statuses)</td>
</tr>
<tr>
  <td>`runningCampaigns` <br /><span class="type-text">integer</span></td>
  <td>Number of Campaigns in <var>running</var> status (see [Campaign API](/docs/Guidelines/Campaign-API-Guidelines#get-campaign-count-by-status) for more info on statuses)</td>
</tr>
<tr>
