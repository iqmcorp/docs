...
Read more about VLD in our [Insights API](/Guidelines/Insights-API-Guidelines/#overview) or our Help Center articles: [Voter Level Data (VLD) Insights Reports](https://help.iqm.com/en/collections/10358580-voter-level-data-vld-insights-reports).
