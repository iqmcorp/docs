...
| Request Schema | |
| --- | --- |
| `providerIds` <br /><span class="type-text">string</span> | Comma separated Provider IDs 
...
| Query Parameters | |
| --- | --- |
| `partnerId` <br /><span class="type-text">integer</span> <span class="required-text">required</span> | Partner ID 
| `providerId` <br /><span class="type-text">integer</span> <span class="required-text">required</span>| Provider ID 
...
Delete an Audience. Endpoint first checks two validations before deleting an Audience:
  ...
  2. Whether Audience IDs are attached to any campaignDetails
