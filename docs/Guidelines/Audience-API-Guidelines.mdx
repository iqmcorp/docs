...
<tr>
  ...
  <td>The percentage of an Audience that IQM can recognize and target</td>
</tr>
<tr>
...
<tr>
  ...
  <td>Retargeted Audience duration</td>
</tr>
<tr>
...
<tr>
  <td>`isAudienceNewPlatform` <br /><span class="type-text">boolean</span></td>
  <td></td>
</tr>
<tr>
  <td>`dataCost` <br /><span class="type-text">integer</span></td>
...
<tr>
  ...
  <td>Array of <var>audienceIds</var> and their <var>statusId</var> and <var>id</var></td>
</tr>
...
<td colSpan="2">
  ...
  <tr>
    ...
    <td>Total number of unique individuals exposed to an ad</td>
  </tr>
    <tr>
    <td>`reachMetadata` <br /><span class="type-text">string</span></td>
    <td>Reach metadata</td>
  </tr>
    <tr>
...
| `showOnlyNonZeroSegments` <br /><span class="type-text">boolean</span> | Returns segments with reach greater than 0: `true`, default: `false`
| `showOnlyReadySegments` <br /><span class="type-text">boolean</span> | Returns segments with <var>ready</var> status: `true`
