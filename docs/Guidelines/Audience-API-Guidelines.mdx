...
| `audienceTypeIds` <br /><span class="type-text">string</span> | [Audience Type IDs](/Guidelines/Audience-API-Guidelines#audience-type-list)
...
<tr>
  ...
  <td>[Audience Type IDs](/Guidelines/Audience-API-Guidelines#audience-type-list) </td>
</tr>
<tr>
...
| `countryIds`<br /><span class="type-text">string</span> | [Country IDs](/Guidelines/Master-API-Guidelines#get-country-segment) 
| `stateIds`<br /><span class="type-text">string</span> | [State IDs](/Guidelines/Master-API-Guidelines#get-state-segment) 
| `cityIds`<br /><span class="type-text">string</span> | [City IDs](/Guidelines/Master-API-Guidelines#get-city-segment)
| `countyIds`<br /><span class="type-text">string</span> | [County IDs](/Guidelines/Master-API-Guidelines#get-county-segment) 
| `senateDistrictIds`<br /><span class="type-text">string</span> | [Senate District IDs](/Guidelines/Master-API-Guidelines#get-senate-district-segment)
| `houseDistrictIds`<br /><span class="type-text">string</span> | [House District IDs](/Guidelines/Master-API-Guidelines#get-house-district-segment) 
| `congressionalDistrictIds`<br /><span class="type-text">string</span> | [Congressional District IDs](/Guidelines/Master-API-Guidelines/#get-congressional-district-segment) 
...
| --- | --- |
| `audienceName` <br /><span class="type-text">string</span> | Audience name 
| `audienceTypeId` <br /><span class="type-text">integer</span> | [Audience Type ID](/Guidelines/Audience-API-Guidelines#audience-type-list)
...
<span class="badge badge--danger">DELETE</span> <span class="path-text">/api/v2/audience/delete</span>
