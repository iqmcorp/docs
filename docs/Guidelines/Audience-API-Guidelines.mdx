...
| `audienceTypeIds` <br /><span class="type-text">string</span> <span class="required-text">required</span>| [Audience type IDs](/Guidelines/Audience-API-Guidelines#create-campaign-audience) 
