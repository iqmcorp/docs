...
<span class="badge badge--success">POST</span> <span class="path-text">/api/v3/conversion/allowed/campaign-list</span>
...
<span class="badge badge--success">POST</span> <span class="path-text">/api/v3/conversion/assign-to/campaign</span>
