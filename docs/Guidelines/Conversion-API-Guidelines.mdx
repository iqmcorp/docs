...
The IQM platform supports two types of conversions. **Pixel** conversions are client-side tracking whereas **Postback** Conversions are server-side.

Pixel conversions feature advanced settings for fine-tuned optimization. 
