...
<td colSpan="2">
  ...
  <table className="objectProperties">
    ...
    <tr>
      ...
      <td>[Prebid Audience Provider ID](/Guidelines/Audience-API-Guidelines/#provider-details-list)</td>
    </tr>
  </table></details>
  </td>
  <td></td>
...
| `addCampaignsList` <br /><span class="type-text">array of integers</span> | [Campaign ID](/Guidelines/Campaign-API-Guidelines#get-list-of-campaigns)s to assign Conversions to |
| `removeCampaignsList` <br /><span class="type-text">array of integers</span> | [Campaign ID](/Guidelines/Campaign-API-Guidelines#get-list-of-campaigns)s to remove assigned Conversions from |
