...
This section covers the various methods and endpoints for getting conversion details and lists. The IQM platform supports postback and pixel type conversions. Pixel conversions are client-side tracking whereas postback conversions are server-side.  
...
export interface paths {
  "/api/v3/conversion/{conversionId}": {
    parameters: {};
    get: operations["getConversionDetailsById"];
  };
}

export interface operations {
  getConversionDetailsById: {
    parameters: {
      query?: {
          typeId?: number;
      };
...
```ts
export interface paths {
 "/api/v3/conversion/list": {
    parameters: {};
    get: operations["getConversionList"];
  };
}
...
```ts
export interface paths {
  "/api/v3/conversion/type-wise-count": {
    parameters: {};
    get: operations["getConversionCountTypeWise"];
  }
}

export interface operations {
  getConversionCountTypeWise: {
    parameters: {
      query?: {
        searchField?: string;
      };
...
```ts
export interface paths {
  "/api/v3/conversion/attached/campaigns/list": {
    parameters: {};
    get: operations["getAttachedCampaignsListByConversionId"];
  };
}

export interface operations {
  getAttachedCampaignsListByConversionId: {
    parameters: {
      query?: {
        conversionId?: string;
      };
...
```ts
export interface paths {
  "/api/v3/conversion/allowed/campaign-list": {
    parameters: {};
    get: operations["getAttachableCampaignListByConversionIds"];
  };
}

export interface operations {
  getAttachableCampaignListByConversionIds: {
    parameters: {
      query?: {
        conversionIds?: string;
...
```ts
export interface paths {
  "/api/v3/conversion/postback/add": {
    parameters: {};
    post: operations["addPostbackConversion"];
  };
}

export interface operations {
  addPostbackConversion: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/conversion/pixel/add": {
    parameters: {};
    post: operations["addPixelConversion"];
  };
}
...
```ts
export interface paths {
  "/api/v3/conversion/delete": {
    parameters: {};
    delete: operations["deleteConversions"];
  };
}
...
```ts
export interface paths {
  "/api/v3/conversion/postback/update": {
    parameters: {};
    patch: operations["updateConversion"];
  };
}
...
```ts
export interface paths {
  "/api/v3/conversion/pixel/update": {
    parameters: {};
    patch: operations["updateConversion_1"];
  };
}
...
export interface paths {
  "/api/v3/conversion/assign-to/campaign": {
    parameters: {};
    post: operations["assignConversionToCampaign"];
  };
}
...
export interface operations {
  assignConversionToCampaign: {
    ...
    requestBody: {
      content: {
        "application/json": {
          conversionIdList?: number[];
          addCampaignsList?: number[];
          removeCampaignsList?: number[];
        };
      };
    };
    responses: {
...
```ts
export interface paths {
  "/api/v3/conversion/pixel/send-email": {
    parameters: {};
    post: operations["sendEmailForPixelConversion"];
  };
}

export interface operations {
  sendEmailForPixelConversion: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/conversion/static/postback/partner-type": {
    parameters: {};
    get: operations["getListOfConversionPartnerType"];
  };
}

export interface operations {
  getListOfConversionPartnerType: {
    parameters: {
      query?: {
        searchField?: string;
...
```ts
export interface paths {
  "/api/v3/conversion/static/pixel/conversion-default-advanced-setting-data": {
    parameters: {};
    get: operations["getConversionDefaultAdvancedSettingData"];
  };
}

export interface operations {
  getConversionDefaultAdvancedSettingData: {
    parameters: {
      header?: {
        Authorization?: string;
        "X-IAA-OW-ID"?: string;
...
```ts
export interface paths {
  "/api/v3/conversion/static/conversion-type": {
    parameters: {};
    get: operations["getListOfConversionTypes"];
  };
}

export interface operations {
  getListOfConversionTypes: {
    parameters: {
      query?: {
        searchField?: string;
...
```ts
export interface paths {
  "/api/v3/conversion/static/conversion-status": {
    parameters: {};
    get: operations["getListOfConversionStatus"];
  };
}

export interface operations {
  getListOfConversionStatus: {
    parameters: {
      query?: {
        searchField?: string;
        statusIds?: string;
...
```ts
export interface paths {
  "/api/v3/conversion/static/conversion-piggyback-type": {
    parameters: {};
    get: operations["getListOfConversionPiggybackTypes"];
  };
}

export interface operations {
  getListOfConversionPiggybackTypes: {
    parameters: {
      query?: {
        searchField?: string;
...
```ts
export interface paths {
  "/api/v3/conversion/static/conversion-attribution-type": {
    parameters: {};
    get: operations["getListOfConversionAttributionTypes"];
  };
}

export interface operations {
  getListOfConversionAttributionTypes: {
    parameters: {
      query?: {
        searchField?: string;
