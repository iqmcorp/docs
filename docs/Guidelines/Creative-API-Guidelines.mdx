...
| `platformCreativeTypeIds`<br /><span class="type-text">array of integers</span> | [Creative type IDs](/docs/Guidelines/Creative-API-Guidelines#get-creative-types-list)
| `creativeStatusIds`<br /><span class="type-text">array of integers</span> | [Creative status IDs](/docs/Guidelines/Creative-API-Guidelines#get-creative-status-list)
...
| --- | --- |
| `creativeIds` <br /><span class="type-text">array of integers</span> | Creative IDs
| `creativeStatusId` <br /><span class="type-text">integer</span> | [Creative status ID](/docs/Guidelines/Creative-API-Guidelines#get-creative-status-list)
| `creativeRejectionReason` <br /><span class="type-text">string</span> | Reason for rejecting Creative if applicable
...
| `creativeTypeId` <br /><span class="type-text">integer</span> | [Creative type ID](/docs/Guidelines/Creative-API-Guidelines#get-creative-types-list)
| `creativeIds` <br /><span class="type-text">array of integers</span> | Creative IDs
...
| `searchField` <br /><span class="type-text">string</span> | Search results by keyword
| `creativeTypeIds` <br /><span class="type-text">array of integers</span> | Filter results by [Creative type IDs](/docs/Guidelines/Creative-API-Guidelines#get-creative-types-list) 
