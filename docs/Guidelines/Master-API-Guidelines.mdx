...
```ts
export interface paths {
  "/api/v2/master/segment/age": {
    parameters: {};
    get: operations["getMasterSegmentAge"];
  };
}
...
```ts
export interface paths {
  "/api/v2/master/segment/language": {
    parameters: {};
    get: operations["getMasterSegmentLanguage"];
  };
}

export interface operations {
  getMasterSegmentLanguage: {
    parameters: {
      query?: {
        pageNo?: number;
        noOfEntries?: number;
...
```ts
export interface paths {
  "/api/v2/master/segment/interest": {
    parameters: {};
    get: operations["getMasterSegmentInterest"];
  };
}

export interface operations {
  getMasterSegmentInterest: {
    parameters: {
      query?: {
        pageNo?: number;
        noOfEntries?: number;
...
```ts
export interface paths {
  "/api/v2/master/segment/income": {
    parameters: {};
    get: operations["getMasterSegmentIncome"];
  };
}

export interface operations {
  getMasterSegmentIncome: {
    parameters: {
      query?: {
        pageNo?: number;
        noOfEntries?: number;
...
```ts
export interface paths {
  "/api/v2/master/segment/ethnicity": {
    parameters: {};
    get: operations["getMasterSegmentEthnicity"];
  };
}

export interface operations {
  getMasterSegmentEthnicity: {
    parameters: {
      query?: {
        pageNo?: number;
        noOfEntries?: number;
...
```ts
export interface paths {
  "/api/v2/master/segment/ethnicity-group": {
    parameters: {};
    get: operations["getMasterSegmentEthnicityGroup"];
  };
}

export interface operations {
  getMasterSegmentEthnicityGroup: {
    parameters: {
      query?: {
        pageNo?: number;
        noOfEntries?: number;
...
```ts
export interface paths {
  "/api/v3/master/traffic-types": {
    parameters: {};
    get: operations["getTrafficTypes"];
  };
}
