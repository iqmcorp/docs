...
| `ids`<br /><span class="type-text">array of integers</span>  <span class="required-text">optional</span> | Selected country ID List, countries with provided IDswill be returned first compared to other records |
...
| Properties ||
| --- | --- |
| `id` <br /><span class="type-text">integer</span> | ID of location as specified by <var>locationTypeId</var> |
| `name` <br /><span class="type-text">string</span> | Location name |
| `parentId` <br /><span class="type-text">integer</span> | Parent ID |
| `geojsonUrl` <br /><span class="type-text">string</span> | Json geographical data URL |
...
| Properties ||
| --- | --- |
| `name` <br /><span class="type-text">string</span> | Creative type name |
| `rtbCampaignTypeId` <br /><span class="type-text">integer</span> | [RTB Campaign Type ID](/Guidelines/Master-API-Guidelines#get-rtb-creative-types) |
| `id` <br /><span class="type-text">integer</span> | Creative type ID |
