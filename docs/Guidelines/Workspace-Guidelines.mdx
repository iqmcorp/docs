...
| `isAvatarUrl` <br /><span class="type-text">boolean</span> | Indicates whether organization has uploaded a logo. If `true`, a default avatar logo is generated when one hasn't been uploaded |
