...
Learn more about Organizations and Workspaces with our [Help Center articles<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1.1em" viewBox="0 0 21 21"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.5 8.5v-5h-5m5 0l-7 7m-1-7h-5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-4"/></svg>](https://help.iqm.com/en/collections/2908829-manage-your-organization). 
