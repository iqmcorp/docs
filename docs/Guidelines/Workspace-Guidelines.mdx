...
See the [IQM Platform Overview](/docs/Getting%20Started/Platform-overview) page for more information on these entities and their hierarchical structure.

Learn more about Organizations and Workspaces with our [Help Center<ExternalLink />](https://help.iqm.com/en/collections/2908829-manage-your-organization) articles. 
...
<td>This caters to advertisers from the political domain targeting users for for issue advocacy, persuasion, event promotion, fundraising and other type of campaigns</td>
</tr>
<tr>
<td> `2`<br /><span class="type-text">Healthcare</span></td>
<td>This caters to advertisers from domains such as pharmaceutical and medical equipment manufacturers targeting healthcare professionals</td>
</tr>
<tr>
<td> `3`<br /><span class="type-text">Specialty</span></td>
<td>This caters to advertisers from niche domains such as automobiles, finance, retail, travel, B2B and others</td>
</tr>
</table>
