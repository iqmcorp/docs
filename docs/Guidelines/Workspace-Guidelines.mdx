...
| `state` <br /><span class="type-text">integer</span> | [State ID](/Guidelines/Master-API-Guidelines#get-state-segment) of Organization location |
| `country` <br /><span class="type-text">integer</span> | [Country ID](/Guidelines/Master-API-Guidelines#get-country-segment) or Organization location |
...
| `verticalId` <br /><span class="type-text">integer</span> | [Vertical ID](/Guidelines/Master-API-Guidelines/#get-verticals)
...
<td>[Status ID](/Guidelines/Workspace-Guidelines#static-details-lists)</td>
</tr>
<tr>
