...
export interface paths {
  "/api/v3/ua/user/allowed-organizations": {
    parameters: {};
    get: operations["GetallowedOrganizationsList"];
  };
}

export interface operations {
  GetallowedOrganizationsList: {
    parameters: {
      query: {
        customerType: string;
        searchField: string;
...
```ts
export interface paths {
  "/api/v3/ua/organization/view-profile": {
    parameters: {};
...
```ts
export interface paths {
  "/api/v3/ua/organization/advertisers/list": {
    parameters: {};
    get: operations["Listadvertiserprofile"];
  };
}

export interface operations {
  Listadvertiserprofile: {
    parameters: {
      query: {
        searchField: string;
        pageNo: number;
...
```ts
export interface paths {
  "/api/v3/ua/organization/advertiser/add": {
    parameters: {};
    post: operations["Addadvertiserprofile"];
  };
}

export interface operations {
  Addadvertiserprofile: {
    parameters: {
      header: {
        Authorization: string;
        "X-IAA-OW-ID": number;
...
```ts
export interface paths {
  "/api/v3/ua/organization/advertiser/{advertiserId}": {
    parameters: {};
    patch: operations["Editadvertiserprofile"];
  };
}
...
export interface paths {
  "/api/v3/ua/organization/advertiser/{advertiserId}": {
    parameters: {};
    delete: operations["Deleteadvertiserprofile"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ua/static/customer-payment-types": {
    parameters: {};
    get: operations["getCustomerPaymentType"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ua/static/organization-expertize": {
    parameters: {};
    get: operations["OrganizationExpertize"];
  };
}

export interface operations {
  OrganizationExpertize: {
    parameters: {
      header: {
        Authorization: string;
      };
...
```ts
export interface paths {
  "/api/v3/ua/static/company-size": {
    parameters: {};
    get: operations["Companysize"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ua/static/media-budget": {
    parameters: {};
    get: operations["Mediabudget"];
  };
}
...
```ts
export interface paths {
 "/api/v3/ua/static/verticals": {
    parameters: {};
    get: operations["getVerticals"];
  };
}
