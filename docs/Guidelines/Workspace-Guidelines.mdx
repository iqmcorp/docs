...
Update Customer operations details. See the [Customer Operations Property Table](#customer-operations-resource-properties) for request schema.
...
Add a new Advertiser profile. Refer to [Advertiser Resource Properties](#advertiser-resource-properties) for request schema.
...
Edit Advertiser profile details. Refer to [Advertiser Resource Properties](#advertiser-resource-properties) for request schema.
