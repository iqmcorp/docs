...
| `runningCampaigns` <br /><span class="type-text">integer</span>| Number of active Campaigns associated with Customer |
...
| `wsId` <br /><span class="type-text">integer</span> | Workspace ID |
