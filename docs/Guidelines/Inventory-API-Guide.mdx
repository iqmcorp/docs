...
| Request Schema  |  |
| ----  | --- |
| `groupIds` <br /><span class="type-text">array of integers</span> | Group IDs to add/remove mappings to/from |
...
| ----  | --- |
| `groupIds` <br /><span class="type-text">array of integers</span>  | Group IDs to add/remove mappings to/from |
| `dealIds` <br /><span class="type-text">array of integers</span>  | Deal IDs to add/remove to/from group |
...
| ---- | --- |
| `groupIds` <br /><span class="type-text">array of integers</span> | Group IDs to add/remove mappings to/from |
| `inventoryIds` <br /><span class="type-text">array of integers</span>  | Inventory IDs to add/remove to/from group |
