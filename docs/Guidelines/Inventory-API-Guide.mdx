...
| ---- | ---- | --- |
| <span class="badge badge--primary">GET</span>  | <span class="path-text">/api/v3/inv/inventories/list</span> | Gets list of inventory available to user |
|<span class="badge badge--primary">GET</span>| <span class="path-text">/api/v3/inv/inventories/distributions</span> | Gets distribution of inventory available for user across country and other parameters |
|<span class="badge badge--primary">GET</span>| <span class="path-text">/api/v3/inv/inventories/count</span> | Gets count of unique inventories, unique publishers, total number of impressions, and total reach of all inventories |
|<span class="badge badge--primary">GET</span>| <span class="path-text">/api/v3/inv/inventory-group-types</span> | Gets list of inventory group types |
