...
| Request Schema |  |
| ---- | --- |
| `grantType` <br /><span class="type-text">string</span> |  [OAuth Grant Types<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="1em" height="1.2em" stroke-width="1.5"><path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6"></path><path d="M11 13l9 -9"></path><path d="M15 4h5v5"></path></svg>](https://oauth.net/2/grant-types/) |
| `email` <br /><span class="type-text">string</span> | User's email |
| `password` <br /><span class="type-text">string</span> | User's password |
...
<tr>
  ...
  <td>Maximum number of entries returned, default: `10`</td>
</tr>
<tr>
...
<tr>
  ...
  <td>Sorts by ascending (`+`) or descending (`-`), default: `+displayName`</td>
</tr>
</table>
...
<tr>
  ...
  <td>User is owner of organization (`true`) or not (`false`)</td>
</tr>
<tr>
  <td>`isModificationAllowed` <br /><span class="type-text">boolean</span></td>
  <td>User is allowed to modify (`true`) or not (`false`)</td>
</tr>
<tr>
...
<tr>
  ...
  <td>User is allowed to assign (`true`) or not (`false`) </td>
</tr>
</table>
