...
<span class="badge badge--primary">GET</span> <span class="path-text">/api/v3/ua/profile</span>
...
<span class="badge badge--primary">GET</span> <span class="path-text">/api/v3/ua/user/config</span>
...
<span class="badge badge--success">POST</span> <span class="path-text">/api/v3/ua/user/password/reset</span>
...
<span class="badge badge--warning">PUT</span> <span class="path-text">/api/v3/ua/user/update-status</span>
...
<span class="badge badge--primary">GET</span> <span class="path-text">/api/v3/ua/user/allowed-applications</span>
...
<span class="badge badge--danger">DELETE</span> <span class="path-text">/api/v3/ua/user/application/revoke</span>
...
<span class="badge badge--success">POST</span> <span class="path-text">/api/v3/ua/user/reset-password/validate</span>
...
<span class="badge badge--success">POST</span> <span class="path-text">/api/v3/ua/user/email/validate</span>
...
<span class="badge badge--success">POST</span> <span class="path-text">/api/v3/ua/user/current-password/validate</span>
