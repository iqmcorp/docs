...
Depending on the grant type, this endpoint can be used to log in via user password, authorization code or client credentials, or it can be used to refresh an access token. 
...
```json title="Request Sample (refresh token)"
{
...
```json title="Request Sample (password)"
{
  "grantType": "password",
  "email": "pratik.t+ihp@iqm.com",
  "password": "123456"
...
```json title="Request Sample (auth code)"
{
  "grantType": "authorization_code",
  "redirect_uri": "http://iqm-authenticator.stage.iqm/showAuthCode",
  "client_id": "demotest",
  "client_secret": "12345"
}
```
