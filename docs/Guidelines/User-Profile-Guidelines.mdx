...
export interface paths {
  "/api/v3/ua/user/invite": {
    parameters: {};
    post: operations["SendUserInvitations"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ua/invite/validate": {
    parameters: {};
    post: operations["ValidateInvite"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ua/user/update-password": {
    parameters: {};
...
```ts
export interface paths {
  "/api/v3/ua/user/reset-password": {
    parameters: {};
    post: operations["ResetPasswordEmail"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ua/user/applications/list": {
    parameters: {};
    get: operations["GetUserApplicationaccesslist"];
  };
}
...
```ts
export interface paths {
  "/api/v3/ua/user/application/add": {
    parameters: {};
    post: operations["AddAppaccessforUser"];
  };
}
