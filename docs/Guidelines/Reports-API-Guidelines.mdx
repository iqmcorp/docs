...
The Reports API allows users to create and schedule custom Reports to generate insights and inform current and future Campaign optimization.
...
See the quickstart guide on [Creating a Report](/docs/Quickstart%20Guides/Reporting-API-Quickstart-Guide).
...
<tr>
  <td>`dimensions` <br /><span class="type-text">serialized JSON string</span></td>
  <td>Represents dimension details serialized as a string</td>
</tr>
<tr>
...
See the quickstart guide on [Scheduling a Report](/docs/Quickstart%20Guides/Schedule-Report-API-Quickstart-Guide).
...
<table>
<th colSpan="2">Custom Fields IDs</th>
<tr>
<td> `3114`</td>
<td>Pixel Conversion 1</td>
</tr>
<tr>
<td> `3221`</td>
<td>Pixel Conversion 2</td>
</tr>
</table>
...
Get dimensions and metrics information grouped by category (see [Complete Table<ExternalLink />](https://help.iqm.com/en/articles/7826036-dimensions-and-metrics)).
