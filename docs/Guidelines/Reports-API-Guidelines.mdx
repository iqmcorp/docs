...
<td>Filters by comma separated Customer IDs <br />Passing <var>all</var> gets all eligible Customer's Report, default: <var>all</var></td>
</tr>
<tr>
...
<tr>
    <td colSpan="2">
      ...
      <td>Delivery frequency type ID <br />Once: <var>1</var> <br />Daily: <var>2</var> <br />Weekly: <var>3</var> <br />Monthly: <var>4</var></td>
      </tr>
        <tr>
      <td>`fileType` <br /><span class="type-text">integer</span></td>
      <td>Report file type ID <br />CSV: <var>1</var> <br />XLS: <var>2</var></td>
      </tr>
      <tr>
...
<tr>
  ...
  <td>Denotes "disaggregated" (daily) (<var>1</var>) or "aggregate" (<var>2</var>) Report request</td>
</tr>
<tr>
  <td>`reportSchedulingEventDetails` <br /><span class="type-text">string</span></td>
  <td>Identifies whether Report is "aggregated" (<var>1</var>) or "disaggregated" (daily) (<var>0</var>)</td>
...
<tr>
  <td>`customerIds` <br /><span class="type-text">array of integers</span></td>
  <td>Gets data for these Customer IDs</td>
</tr>
<tr>
...
| `requestType` <br /><span class="type-text">integer</span> | ID for whether Report is "disaggregated" (daily) (<var>1</var>) or "aggregated" (<var>2</var>)
...
<tr>
<td>`customerIds` <br /><span class="type-text">array of integers</span></td>
<td>Customer IDs to add to Report. Parameter only available to update by workspace users or users with Customers</td>
</tr>
<tr>
  <td>`startDate` <br /><span class="type-text">integer</span></td>
  <td>Unix epoch timestamp of start date for Report</td>
...
<tr>
  <td>`requestType` <br /><span class="type-text">integer</span></td>
  <td>ID for whether Report is "disaggregated" (daily) (<var>1</var>) or "aggregated" (<var>2</var>)</td>
</tr>
<tr>
...
| `fileType` <br /><span class="type-text">integer</span>| Report file type ID <br />CSV: <var>1</var> <br />XLS: <var>2</var> |
| `deliveryFrequency` <br /><span class="type-text">integer</span> | Delivery frequency type ID <br />Once: <var>1</var> <br />Daily: <var>2</var> <br />Weekly: <var>3</var> <br />Monthly: <var>4</var> |
