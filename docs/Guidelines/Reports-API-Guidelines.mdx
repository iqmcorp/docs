...
See the QuickstartGuides on [Creating a Campaign](/Quickstart%20Guides/Upload-Creative-and-Create-a-Campaign-API-Quickstart-Guide), then [Creating a Report](/Quickstart%20Guides/Reporting-API-Quickstart-Guide) and [Scheduling a Report](/Quickstart%20Guides/Schedule-Report-API-Quickstart-Guide).
...
See the QuickstartGuide on [Creating a Report](/Quickstart%20Guides/Reporting-API-Quickstart-Guide).
...
See the QuickstartGuide on [Scheduling a Report](/Quickstart%20Guides/Schedule-Report-API-Quickstart-Guide).
