...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/matched/{audienceId}" operationId="getMatchedAudienceById" />
...
| Path parameter | |
| --- | --- |
| `audienceId` <br /><span class="type-text">string</span> | [Matched audience ID](/guidelines/audience-api/#audience-details-list). |

| Query parameters | |
| --- | --- |
| `campaignTargetingRequired` <br /><span class="type-text">boolean</span> <span class="required-text">optional</span> | Flag to indicate if campaign targeting details are returned, default: <var>false</var>. |
| `userDetailsRequired` <br /><span class="type-text">boolean</span> <span class="required-text">optional</span> | Flag to indicate if user details are returned, default: <var>false</var>. |
