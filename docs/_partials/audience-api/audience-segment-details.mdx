...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/segmented/{audienceId}" operationId="getSegmentedAudience" />

<div class="endpoint-container">
  <div class="child1">

Get Segmented audience details by ID. 
...
<tr>
  ...
  <td>Segment [Partner ID](/guidelines/audience-api#segment-partner-provider-list).</td>
</tr>
<tr>
...
<tr>
  ...
  <td>Array of Segmented audiences.</td>
</tr>
<tr>
<td colSpan="2">
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/audience/segmented/search/list" operationId="getSegmentsSearchList" />
<br /><CopyUrl method="POST" url="https://api.iqm.com/api/v3/audience/segmented/search/list/download" operationId="downloadSegmentsSearchList" />
...
| `sortBy` <br /><span class="type-text">string</span>| Sorts results by specified field. For ascending use plus(+) sign and for descending use minus (-) sign.
...
| `verticalIds` <br /><span class="type-text">array of integers</span> | [Vertical IDs](/guidelines/workspace-api/#verticals) to filter returned data by.
| `partnerIds` <br /><span class="type-text">array of integers</span> | [Partner IDs](#segment-partner-provider-list) to filter returned data by.
| `providerIds` <br /><span class="type-text">array of integers</span> | [Provider IDs](#segment-partner-provider-list) to filter returned data by.
| `priceRangeIds` <br /><span class="type-text">array of integers</span> | [Price range IDs](#price-range-list-for-segmented-audiences) to filter returned data by.
| `reachRangeIds` <br /><span class="type-text">array of integers</span> | [Reach range IDs](#reach-range-list-for-segmented-audiences) to filter returned data by.
...
<tr>
  ...
  <td>[Partner ID](/guidelines/audience-api#segment-partner-provider-list).</td>
</tr>
<tr>
  <td>`reachMetadata` <br /><span class="type-text">object</span></td>
