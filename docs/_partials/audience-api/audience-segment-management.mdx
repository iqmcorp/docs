...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/audience/segmented" operationId="createSegmentedAudience" />

<div class="endpoint-container">
  <div class="child1">

Creates a Segmented audience based on the provided request parameters.

Using Segment IDs ([Search Segmented audiences](#search-segmented-audiences)), you can build an audience with the <var>equation</var> field. Segment IDs in parentheses, separated by a vertical bar (|), are in an 'or' relationship, which combines the sets of Segments; groups of Segments in parentheses, separated by an ampersand (&), are in an 'and' relationship, which builds an audience based on the intersection of those groups. 
...
<CopyUrl method="PUT" url="https://api.iqm.com/api/v3/audience/segmented/{audienceId}" operationId="updateSegmentedAudience" />
