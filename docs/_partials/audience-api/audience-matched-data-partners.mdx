...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/static/data-partners" operationId="getAudienceDataPartners" />
...
* For Workspace/super users, a [vertical ID](/guidelines/workspace-api/#verticals) should be passed explicitly.
* [Audience type ID](/guidelines/audience-api#audience-type-list) is mandatory to fetch data partners.
...
| `audienceSubtypeIds` <br /><span class="type-text">integer</span> | [Audience subtype ID](/guidelines/audience-api/#audience-subtype-list). |
| `verticalId` <br /><span class="type-text">integer</span> | [Vertical ID](/guidelines/workspace-api/#verticals). |
| `active` <br /><span class="type-text">boolean</span> | Filter for active data partners. |
