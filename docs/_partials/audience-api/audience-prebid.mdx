...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/prebid/{audienceId}" operationId="getPrebidAudienceDetails" />
...
| Path parameter | |
| --- | --- |
| `audienceId` <br /><span class="type-text">string</span> | [Pre-bid audience ID](/guidelines/audience-api/#audience-details-list). |
...
<td colSpan="2">
  ...
  <td>Indicates that an audience segment is a leaf node in a hierarchical audience structure: <var>true</var>.</td>
    ...
    <td>[Provider ID](/guidelines/audience-api/#segment-partner-provider-list).</td>
  </tr>
    <tr>
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/audience/prebid/segments/search/list" operationId="getPrebidSegmentDetailsBySearch" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/audience/prebid" operationId="createPrebidAudience" />
...
| `prebidProviderId` <br /><span class="type-text">integer</span> | Pre-bid audience [provider ID](/guidelines/audience-api/#segment-partner-provider-list). |
...
<CopyUrl method="PATCH" url="https://api.iqm.com/api/v3/audience/prebid/{audienceId}" operationId="updatePrebidAudience" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/prebid/static/providers/child-segments" operationId="getProviderDetailsWithChildSegments" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/prebid/segments/children" operationId="getPrebidChildSegmentDetailsByParentId" />

<div class="endpoint-container">
  <div class="child1">

Get the pre-bid child segment details based on the parent pre-bid segment ID.
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/prebid/dv-ivt/free-segments" operationId="getDvIvtFreePrebidSegments" />
