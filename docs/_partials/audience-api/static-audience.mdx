...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/segmented/static/reach-range" operationId="getSegmentReachRange" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/segmented/static/price-range" operationId="getSegmentPriceRange" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/static/audience-types" operationId="getAudienceTypes" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/static/audience-subtypes" operationId="getAudienceSubtypes" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/static/audience-status" operationId="getAudienceStatuses" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/static/frequency-types" operationId="getFrequencyTypes" />
...
function GetGeofarmedFrequencyTypes(): Promise<Responses> {
  const options = {
    method: 'GET',
    url: 'https://api.iqm.com/api/v3/audience/static/frequency-types',
  };
