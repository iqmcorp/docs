...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/audience/abm/{audienceId}" operationId="getAccountBasedAudienceDetailsByAudienceId" />

<div class="endpoint-container">
  <div class="child1">

Get Account Based Marketing (ABM) audience details by ID. 
...
<td colSpan="2">
  ...
  <td>[Healthcare account subtype IDs](/guidelines/audience-api#healthcare-account-subtypes).</td>
  </tr>
      <tr>
