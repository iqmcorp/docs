...
Read more about SLS in our [Insights API](/guidelines/insights-api/#overview) or our Help Center articles: [Script Lift Study (SLS) Insights Reports](https://help.iqm.com/en/collections/12083517-script-lift-study-sls-insights-reports).
