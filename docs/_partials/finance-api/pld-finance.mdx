...
Read more about PLD in our [Insights API](/guidelines/insights-api) or our Help Center articles: [Provider Level Data (PLD) Insights Reports](https://help.iqm.com/en/collections/12010878-provider-level-data-pld-insights-reports).
