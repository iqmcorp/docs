...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/ins/static/insights/type/list" operationId="getInsightsType" />
...
<table>
<th colSpan="2">Insights type IDs</th>
<tr>
<td> `1`</td>
...
### Get list of Insights status types

<CopyUrl method="GET" url="https://api.iqm.com/api/v3/ins/static/insights/status/list" operationId="getInsightsStatus" />
...
### Get list of template status types

<CopyUrl method="GET" url="https://api.iqm.com/api/v3/ins/static/template-status" operationId="getTemplateStatuses" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/ins/static/scheduling/frequencies" operationId="getFrequencyMetadata" />
