...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/ins/vld-reports" operationId="getVLDReportList" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/ins/vld/campaigns" operationId="getStatusWiseCampaignsForVLDReports" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/ins/vld-report" operationId="generateVLDReports" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/ins/vld-reports/computation" operationId="getChargeableImpressionsDataForVLDReports" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/ins/vld-report/download" operationId="getVLDReportDownloadUrl" />
...
<CopyUrl method="DELETE" url="https://api.iqm.com/api/v3/ins/vld-report" operationId="deleteFailedVLDReport" />
