...
| --- | --- |
| `success` <br /><span class="type-text">boolean</span> | Indicates resource retrieval was succesful: <var>true</var>
...
In some cases, POST endpoint function like a GET endpoint, where the request schema uses the [API Filtering and Pagination](/Getting%20Started/API-Pagination-Guide) parameters to sort the retrieved data. 
