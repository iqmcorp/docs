...
The <span class="badge badge--primary">GET</span> method allows you to retrieve resources in the IQM API. Within each API you can retrieve details of individual objects, usually by querying their ID, lists of objects with filters, or static entities. Many <span class="badge badge--primary">GET</span> endpoints support queries to filter and sort the data, learn more about that by reviewing [API Filtering and Pagination](/Getting%20Started/API-Pagination-Guide).
