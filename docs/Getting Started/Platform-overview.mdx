...
<tr>
  ...
  <td>[<span class="badge bar badge--success">POST</span><span class="path-text">/api/v3/crt/creatives/groups</span>](/docs/Guidelines/Creative-API-Guidelines#create-new-creative-group)</td>
    <td></td>
</tr>
<tr>
  <td>Add or Remove Creative to/from Group</td>
  <td>[<span class="badge bar badge--success">POST</span><span class="path-text">/api/v3/crt/creatives/groups/modify-creatives</span>](/docs/Guidelines/Creative-API-Guidelines#modify-creatives)</td>
    <td></td>
</tr>
</table>
</center>
...
<tr>
  ...
  <td>[<span class="badge bar badge--primary">GET</span><span class="path-text">/api/v3/ua/customers/list</span>](/docs/Guidelines/Workspace-Guidelines#get-customer-details)</td>
    <td></td>
</tr>
<tr>
