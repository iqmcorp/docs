...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/ins/insights/list" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/ins/insights/type-wise-count" />
...
<CopyUrl method="DELETE" url="https://api.iqm.com/api/v3/ins/insights/delete" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/ins/insights/regenerate/{insightsId}" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/ins/send-email" />
