...
| `deviceType` <br /><span class="type-text">string</span> | Comma separated device type IDs |
| `trafficType` <br /><span class="type-text">string</span> | Comma separated traffic type IDs |
...
| `isCampaignFromNewPlatform` <br /><span class="type-text">boolean</span> |
...
| `isUnapprovedAudienceTargeted` <br /><span class="type-text">boolean</span> |
| `isAllAudienceUnapproved` <br /><span class="type-text">boolean</span> |
...
| `campaignTypeId` <br /><span class="type-text">integer</span> | Campaign type ID |
| `budgetTypeId` <br /><span class="type-text">integer</span> | Budget type ID |
| `isEstimatorAvailable` <br /><span class="type-text">boolean</span> |
| `isAdvancedAudioVideoTargeted` <br /><span class="type-text">boolean</span> | `true` indicates advanced targeting is enabled |
| `isEditAccess` <br /><span class="type-text">boolean</span> |
| `isMarginSet` <br /><span class="type-text">boolean</span> |
| `isApprovalAccess` <br /><span class="type-text">boolean</span> |
| `isParentInvoiceTemplateSet` <br /><span class="type-text">boolean</span> |
...
|`creativeType`	<br /><span class="type-text">integer</span> |	Creative type ID
|`campaignType`	<br /><span class="type-text">integer</span> |	Campaign type ID
|`totalBudgetPacing` <br /><span class="type-text">boolean</span> |	Budget is spent equally every hour
...
|`timezone`	<br /><span class="type-text">integer</span> |	Timezone ID for campaign
...
|`bidOptimization` <br /><span class="type-text">boolean</span> |	Optimize bid price based on analysis.
|`bidPacing` <br /><span class="type-text">boolean</span> |	Budget is spent equally every hour.
|`impressionCapping` <br /><span class="type-text">integer</span> |	Maximum impressions in one inventory.
|`maxDayClicks` <br /><span class="type-text">integer</span> |	Maximum daily clicks
|`totalClicks` <br /><span class="type-text">integer</span> |	Total clicks
...
|`conversionTypeId` <br /><span class="type-text">integer</span> |	Conversion type Id which represents the type of conversion attached to it. This parameter is mandatory with conversionIds
...
|`carriers` <br /><span class="type-text">string</span> |	Carrier targeting. Value in form of String of comma separated IDs of targeted carrier(s)
...
|`deviceType` <br /><span class="type-text">string</span> |	Device targeting. Value in form of String of comma separated IDs of targeted device type(s)
|`trafficType` <br /><span class="type-text">string</span> |	Traffic type targeting. Value in form of String of comma separated IDs of targeted traffic type(s)
|`manufacturer` <br /><span class="type-text">string</span> |	Manufacturer targeting. Value in form of String of comma separated IDs of targeted manufacturer type(s)
|`os` <br /><span class="type-text">string</span> |	OS targeting. Value in form of String of comma separated IDs of targeted OS
...
|`exchanges` <br /><span class="type-text">string</span> |	Targeted exchanges. Value in form of String of comma separated IDs of exchanges
|`prebidAudienceSegmentIdList` <br /><span class="type-text">array of integers</span> |	Prebid Audience Segment IDs to attach campaign to segment IDs
|`device` <br /><span class="type-text">string</span> |	Targeted devices as string
|`publisherAdCategory` <br /><span class="type-text">string</span> |	Target Publisher ad category. Value in form of String of comma separated IDs
...
|`stateIds` <br /><span class="type-text">string</span> |	State Target (It will be considered as White list State Target). Value in form of String of comma separated IDs.
...
|`ageRangeIds` <br /><span class="type-text">string</span> |	Target age range. Value in form of string of comma separated IDs
|`genderIds` <br /><span class="type-text">string</span> |	Target gender. Value in form of String of comma-separated IDs
|`interestIds` <br /><span class="type-text">string</span> |	Target user interest. Value in form of a string of comma-separated IDs
|`incomeRangeIds` <br /><span class="type-text">string</span> |	Target user income range. Value in form of a string of comma-separated IDs
|`languageIds` <br /><span class="type-text">string</span> |	Target user language. Value in form of a string of comma-separated IDs
|`ethnicityIds` <br /><span class="type-text">string</span> |	Target user ethnicity. Value in form of a string of comma-separated ID
...
| `timeZoneId` <br /><span class="type-text">integer</span> | Filters data in report for provided timezone ID |
