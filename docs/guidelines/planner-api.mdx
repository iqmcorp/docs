...
The Planner API allows you to draft an ad strategy proposal that meets an Advertiser's requirements while also achieving campaign goals.
...
### More resources
  * [Planner proposal overview<ExternalLink />](https://help.iqm.com/en/articles/10104696-planner-proposal-overview) Help Center articles
  * [Healthcare Professional (HCP) Planner](/healthcare-vertical/planner/) guidelines
  * [Political Planner](/political-vertical/planner/) guidelines
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/plan/proposal/{proposalId}" operationId="getProposalDetailsById" />
...
<td>Margin percentage applied on top of base CPM, not a currency amount (range: 0-100).</td>
</tr>
<tr>
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/plan/proposals" operationId="proposalDetailList" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/plan/proposal-summary/reach-impressions" operationId="getReachAndImpressions" />
...
<td colSpan="2">
  ...
  <tr>
    <td>`creativeTypeIds`<br /><span class="type-text">array of integers</span></td>
    <td>[Creative type ID](/guidelines/master-api#get-rtb-creative-types).</td>
  </tr>
  </table></details>
  </td>
</tr>
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/plan/proposal-summary/device-type" operationId="getDeviceTypeData" />

<div class="endpoint-container">
  <div class="child1">

Get summary of impressions distribution for different device types targeted in a proposal.
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/plan/proposal-summary/channel-type" operationId="getChannelTypeData" />

<div class="endpoint-container">
  <div class="child1">

Get summary of impressions distribution for different channel types targeted in a proposal.
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/plan/proposal-summary/bid-landscape" operationId="getBidLandscapeData" />

<div class="endpoint-container">
  <div class="child1">

Get summary of impressions distribution for different bid landscapes targeted in a proposal.
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/plan/proposal/{proposalId}/download" operationId="generateS3LinkForDownloadProposal" />

<div class="endpoint-container">
  <div class="child1">

Get download URL for proposals with statuses: <var>ready</var>, <var>failed</var>, <var>converted</var>, or <var>expired</var>.

| Query parameters | |
| --- | --- |
| `fileType` <br /><span class="type-text">integer</span> | Type of file to download.<br />Excel: <var>1</var>. <br />CSV: <var>2</var>. <br />PDF: <var>3</var>.
| `proposalId` <br /><span class="type-text">integer</span> | [Proposal ID](#get-list-of-proposals).
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/plan/proposal/add" operationId="createProposal" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/plan/proposal/draft" operationId="addDraftProposal" />
...
<CopyUrl method="PATCH" url="https://api.iqm.com/api/v3/plan/proposal/{proposalId}" operationId="editReadyProposal" />
...
<td>Proposal max impressions.</td>
</tr>
<tr>
...
<tr>
  ...
  <td>Deleted [campaign IDs](/guidelines/campaign-api#get-list-of-campaigns).</td>
</tr>
</table>
...
<CopyUrl method="PATCH" url="https://api.iqm.com/api/v3/plan/proposal/draft/{proposalId}" operationId="updateDraftProposal" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/plan/proposal/{proposalId}/campaigns" operationId="generateIOCampaigns" />

<div class="endpoint-container">
  <div class="child1">

Convert a proposal into an insertion order with draft campaigns. The proposal status updates to <var>processing</var> and triggers async campaign generation; once completed the status becomes <var>converted</var>. The target proposal must be in <var>ready</var> or <var>failed</var> status.
...
<CopyUrl method="PATCH" url="https://api.iqm.com/api/v3/plan/proposals/restore" operationId="restoreReadyProposal" />
...
| Request schema | |
| --- | --- |
| `proposalIds` <br /><span class="type-text">array of integers</span> | [Proposal IDs](#get-list-of-proposals).
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/plan/proposal/{proposalId}/duplicate" operationId="createDuplicateProposal" />
...
<CopyUrl method="DELETE" url="https://api.iqm.com/api/v3/plan/proposal" operationId="softDeleteProposal" />
...
| Query parameters | |
| --- | --- |
| `proposalIds` <br /><span class="type-text">string</span> | Comma separated [proposal IDs](#get-list-of-proposals).
...
```json title="Response 200 (single proposal)"
{
  "success": true,
  "data": {
...
```json title="Response 200 (multiple proposals)"
{
  "success": true,
  "data": {
    "message": "2 Proposals deleted successfully"
  }
}
```
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/plan/static/proposal/status" operationId="ProposalStatusList" />

<div class="endpoint-container">
  <div class="child1">

Get a list of proposal status IDs.
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/plan/proposal-summary/supported-params" operationId="getSupportedParameters" />

<div class="endpoint-container">
  <div class="child1">

Get a list of supported parameters for proposal summaries. 
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/plan/proposal/margin" operationId="getDefaultCustomerMargin" />
...
<table className="objectProperties">
    ...
    <td>The Customer/Workspace's default gross margin percentage, sourced from Finance, a suggested default to pre-fill when creating a proposal, not the same field as a specific proposal's own <var>margin</var>/<var>marginValue</var> (see [Create proposal](#create-proposal)).</td>
    </tr>
</table></details>
