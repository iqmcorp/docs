...
### More Resources
  ...
  * [Healthcare Professional Proposal (HCP) Planner](/healthcare-vertical/planner/) Guidelines
...
<td>Margin percentage applied on top of base CPM, not a currency amount. Valid range: 0-100 -- values outside this range are rejected with "Margin percentage should be within 0 to 100".</td>
</tr>
<tr>
