...
<td>Indicates email is valid: <var>true</var></td>
</tr>
<tr>
<td>`message` <br /><span class="type-text">string</span></td>
<td>Success message</td>
...
<table className="objectProperties">
<tr>
<td>`owId` <br /><span class="type-text">boolean</span></td>
<td>Indicates Report was succesfully created: <var>true</var></td>
</tr>
<tr>
...
| `tags` <br /><span class="type-text">array of strings</span> | [Customer Type IDs](#customer-type) |
