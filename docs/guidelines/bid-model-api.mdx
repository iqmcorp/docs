...
You can fine-tune metrics such as where ads appear (Include/Exclude), manage Campaign priority, and dimensions by which a Campaign is subdivided. This page covers the common endpoints and methods associated with the Bid Model API.
...
For IDs see endpoint documentation for [Device Type](/guidelines/master-api#get-device-type), [Exchanges](/guidelines/master-api#get-exchanges), and [Traffic Source](/guidelines/master-api#get-traffic-types) in the [Master API](/guidelines/master-api).
...
Create a Bid Model bundle for the specified Campaign and Dimension IDs. A Bid Model Bundle allows you to group multiple dimension entities and apply modeling attributes at the bundle level with the [Manage Bid Modeling](#manage-bid-modeling) endpoint.  
| Path Parameters |  |
| --- | --- |
| `campaignId` <br /><span class="type-text">integer</span> | [Campaign ID](/guidelines/campaign-api#get-list-of-campaigns) |
| `dimensionId` <br /><span class="type-text">integer</span> | [Dimension ID](#get-list-of-bid-model-dimensions) |
...
| --- | --- |
| `campaignIds` <br /><span class="type-text">string</span> | Comma separated [Campaign ID](/guidelines/campaign-api#get-list-of-campaigns)s
...
| <span class="code-text">campaignIds</span> <br /><span class="type-text">array of integers</span> <span class="required-text">required</span> | [Campaign ID](/guidelines/campaign-api#get-list-of-campaigns)s   |
