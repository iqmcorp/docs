...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/bm/campaigns/{campaignId}/bundles" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/bm/bid-models/dimension/entity" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/bm/campaign/{campaignId}/dimensions/bid-models/count" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/bm/campaigns/{campaignId}/dimension/{dimensionId}/spent" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/bm/campaigns/{campaignId}/bid-models/dimensions/{dimensionId}" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/bm/campaigns/{campaignId}/include-Exclude/dimensions/{dimensionId}" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/bm/campaigns/{campaignId}/dimensions/{dimensionId}/bundles" />
...
<CopyUrl method="PATCH" url="https://api.iqm.com/api/v3/bm/campaigns/{campaignId}/dimensions/{dimensionId}/bundles" />
...
<CopyUrl method="DELETE" url="https://api.iqm.com/api/v3/bm/campaigns/{campaignId}/dimensions/{dimensionId}/bundles" />
...
<CopyUrl method="PUT" url="https://api.iqm.com/api/v3/bm/io/{ioId}/bid-models" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/bm/io/{ioId}/bid-models" />
<br /><CopyUrl method="DELETE" url="https://api.iqm.com/api/v3/bm/io/{ioId}/bid-models" />
<br /><CopyUrl method="PATCH" url="https://api.iqm.com/api/v3/bm/io/{ioId}/bid-models" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/bm/campaigns/{campaignId}/reports/{dimensionId}" />
...
<CopyUrl method="GET" url="/api/v3/bm/static/dimensions" />
