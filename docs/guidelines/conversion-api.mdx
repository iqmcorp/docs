...
The Conversions API allows you to create and manage Conversions to track user traffic for advertising Campaigns. 
...
A Conversion <var>id</var> can be used to [Get Conversion Details by ID](#get-conversion-details-by-id) and to perform various actions in [Conversions Managment](#conversions-management) endpoints.
...
<tr>
  ...
  <td>[Instertion Order Status ID](/guidelines/campaign-api#get-io-status-list)</td>
</tr>
<tr>
...
<td colSpan="2">
  ...
  <table className="objectProperties">
    ...
    <tr>
      ...
      <td>[Prebid Audience Provider ID](/guidelines/audience-api/#segment-partner-provider-list)</td>
    </tr>
  </table></details>
  </td>
  <td></td>
...
| Query Parameters  |  |
| ----  | --- |
| `conversionIds` <br /><span class="type-text">string</span> | Comma separated [Conversion ID](#get-list-of-conversions)s to delete|
...
| Request Schema |  |
| ---- | --- |
| `conversionIdList` <br /><span class="type-text">array of integers</span> | [Conversion ID](#get-list-of-conversions)s to assign |
| `addCampaignsList` <br /><span class="type-text">array of integers</span> | [Campaign ID](/guidelines/campaign-api#get-list-of-campaigns)s to assign Conversions to |
| `removeCampaignsList` <br /><span class="type-text">array of integers</span> | [Campaign ID](/guidelines/campaign-api#get-list-of-campaigns)s to remove assigned Conversions from |
