...
The Asset API streamlines the management and storage of assets in the system, such as images, PDF files, and HTML5 creative assets (ZIP files). This service plays a critical role in handling media uploads, temporary storage, and coordination with other services (such as the Creative API) for final storage and metadata management.

This page covers the common endpoints and methods associated with the Asset API.

### More resources

  * [Creative ad specs and requirements<ExternalLink />](https://help.iqm.com/en/articles/7019246-creative-ad-specs-and-requirements) Help Center article 
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/asset/list" operationId="getAllAssets" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/asset/{assetId}" operationId="getAssetDetails" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/asset" operationId="addAssets" />
...
<CopyUrl method="PATCH" url="https://api.iqm.com/api/v3/asset/{assetId}" operationId="updateAssetDetails" />
...
<CopyUrl method="DELETE" url="https://api.iqm.com/api/v3/asset/{assetId}" operationId="deleteAsset" />
