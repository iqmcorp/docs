...
| Path Parameter | |
| --- | --- |
| `id` <br /><span class="type-text">string</span> | Matched [Audience ID](/Guidelines/Audience-API-Guidelines#audience-details-list) |
...
<tr>
  ...
  <td>[Audience ID](/Guidelines/Audience-API-Guidelines#audience-details-list)</td>
</tr>
<tr>
...
| Path Parameter | |
| --- | --- |
| `matched_audience_id` <br /><span class="type-text">integer</span> | Matched [Audience ID](/Guidelines/Audience-API-Guidelines#audience-details-list)
...
| Path Parameter | |
| --- | --- |
| `audienceId` <br /><span class="type-text">integer</span> | ABM [Audience ID](/Guidelines/Audience-API-Guidelines#audience-details-list) |
