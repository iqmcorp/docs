...
IQM's APIs provide access to all dimensions and KPIs of your ad-serving Reporting data in JSON format. You can use the APIs to connect to applications of your choice.
