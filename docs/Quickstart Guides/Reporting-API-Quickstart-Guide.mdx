...
For more information see this [Help Center<ExternalLink />](https://help.iqm.com/en/collections/11287049-report-dimensions-and-metrics) article about Conversions and  the complete [Dimension and Metrics Details API Documentation](/Guidelines/Reports-API-Guidelines#get-dimensions-and-metrics-details).
