...
For more information see this [Help Center<ExternalLink />](https://help.iqm.com/en/articles/7329794-understanding-conversion-metrics-in-the-iqm-platform) article about Conversions and  the complete [Dimension and Metrics Details API Documentation<ExternalLink />](https://api.iqm.com/docs/?path=tag/Report-API/operation/getDimensionAndMetricDetails).
