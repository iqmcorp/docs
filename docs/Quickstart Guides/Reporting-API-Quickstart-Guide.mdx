...
<br /><span class="badge badge--primary">GET</span> <span class="path-text">/api/v3/master/timezones</span>
...
The minimum requirements to perform this task are: logging in with authentication credentials, selectings dimensions and metrics, choosing a timezone, and executing a report. Once these steps are accomplished, more can be learned about IQM's API through the [guidelines pages](/docs/Guidelines/).

1. Log In
      * Optional if user has already logged in and has a token
1. Request Dimensions and Metrics
      * Optional if user knows supported/desired dimensions/metrics
1. Request Timezones
      * Optional if user already knows supported/desired ID values
...
Choose the dimensions and metrics desired for the report. This API offers Dimension and Metrics information grouped by category.
 See [full documentation on dimensions and metrics<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1.1em" viewBox="0 0 21 21"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.5 8.5v-5h-5m5 0l-7 7m-1-7h-5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-4"/></svg>](https://help.iqm.com/en/articles/7826036-dimensions-and-metrics) IQM supports.
...
For more information see this [help article about Conversions<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1.1em" viewBox="0 0 21 21"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.5 8.5v-5h-5m5 0l-7 7m-1-7h-5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-4"/></svg>](https://help.iqm.com/en/articles/7329794-understanding-conversion-metrics-in-the-iqm-platform) and  the complete [Dimension and Metrics Details API Documentation<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1.1em" viewBox="0 0 21 21"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.5 8.5v-5h-5m5 0l-7 7m-1-7h-5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-4"/></svg>](https://app.iqm.com/docs/?path=tag/Report-API/operation/getDimensionAndMetricDetails).
...
For further information see the complete [Timezone API documentation](/docs/Guidelines/Master-API-Guidelines#get-timezones).
...
For further information see the complete [Execute Report Data API](/docs/Guidelines/Reports-API-Guidelines#execute-a-report).
