...
The minimum requirements to perform this task are: logging in with authentication credentials, selectings dimensions and metrics, choosing a timezone, and executing a report. Once these steps are accomplished, more can be learned about IQM's API through the [Guidelines](/docs/Guidelines/) pages.
