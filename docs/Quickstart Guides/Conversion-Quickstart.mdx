...
<td colSpan="2">
  ...
  <table className="objectProperties">
  <tr>
  <td>`conversionDuration` <br /><span class="type-text">object</span> <span class="required-text">optional</span></td>
...
Pass the <var>id</var> returned in Step 2 in the <var>conversionIdList</var> array along with the Campaign ID in the <var>addCampaignsList</var> array to assign the created Conversion to the desired Campaign. 
