...
This quickstart will cover how to create a matched audience.  The minimum requirements to perform this task are: logging in with authentication credentials, selecting columns for matching, and uploading an audience. Once these steps are accomplished, more can be learned about IQM's API through the [guidelines pages](/docs/Guidelines/).
