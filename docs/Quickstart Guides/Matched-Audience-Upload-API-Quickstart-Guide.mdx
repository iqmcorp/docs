...
For further information see the complete [Matched Audience Fields API Documentation<ExternalLink />](https://app.iqm.com/docs?path=tag/Audience-API/operation/GetMatchedAudienceFields).
...
For further information see the complete [Matched Audience Upload API Documentation<ExternalLink />](https://app.iqm.com/docs?path=tag/Audience-API/operation/addMatchedAudience).
...
For further information see the complete [Matched Audience Details API Documentation<ExternalLink />](https://app.iqm.com/docs?path=tag/Audience-API/operation/GetMatchedAudienceDetails).
