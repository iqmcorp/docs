...
| Headers|  |
| ----  | --- |
| `Authentication` <br /><span class="type-text">string</span>  | Authentication Bearer Token<br />See [Authentication Guide](/Quickstart%20Guides/Authentication-Quickstart-Guide)<br /> |
