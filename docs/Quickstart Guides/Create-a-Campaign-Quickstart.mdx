...
Learn more by reading the [Campaigns Overview<ExternalLink />](https://help.iqm.com/en/articles/11497668-campaigns-overview) Help Center Article. 
...
To run a Campaign, it must be approved. Use the <var>campaignId</var> returned from Step 3 to check the created Campaign's status and other details.
