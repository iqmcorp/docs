...
To generate a VLD Report, first use the <var>campaignId</var> and the Get Campaign Details endpoint to check if the eligiblity requirements are met. 
...
To generate a PLD Report, first use the <var>campaignId</var> and the Get Campaign Details endpoint to check if the eligiblity requirements are met. 
