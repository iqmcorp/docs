...
<br /><span class="badge bar badge--primary">GET</span> <span class="path-text">/api/v3/ins/campaign/bid-insights/\{campaignId\}</span>
<br /><span class="badge bar badge--success">POST</span> <span class="path-text">/api/v3/ins/insights/add</span>
<br /><span class="badge bar badge--success">POST</span> <span class="path-text">/api/v3/ins/insights/download</span>
<br /><span class="badge bar badge--success">POST</span> <span class="path-text">/api/v3/cmp/audience/targeting</span>
<br /><span class="badge bar badge--success">POST</span> <span class="path-text">/api/v3/ins/vld-report</span>
<br /><span class="badge bar badge--success">POST</span> <span class="path-text">/api/v3/ins/vld-report/download</span>
<br /><span class="badge bar badge--success">POST</span> <span class="path-text">/api/v3/ins/pld-report</span>
<br /><span class="badge bar badge--success">POST</span> <span class="path-text">/api/v3/ins/pld-report/download</span>
...
<tr>
  ...
  <td>[Upload a Matched Audience](/Tutorials/Upload-a-Matched-Audience)<br />[Audience API](/Guidelines/Audience-API-Guidelines)<br />[Audience Status Type ID](/Guidelines/Audience-API-Guidelines#audience-count-by-status)<br />[Audience Type ID](/Guidelines/Audience-API-Guidelines#audience-type-list)</td>
</tr>
<tr>
