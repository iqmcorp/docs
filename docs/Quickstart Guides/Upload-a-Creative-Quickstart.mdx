...
<br /><span class="badge bar badge--success">POST</span> <span class="path-text">/api/v3/asset</span>
<br /><span class="badge bar badge--success">POST</span><span class="path-text">/api/v3/crt/creatives</span>
<br /><span class="badge badge--primary">GET</span> <span class="path-text">/api/v3/crt/creatives/\{creativeId}</span>
...
| Query Parameters | |
| --- | --- |
| `filesMetaData` <br /><span class="type-text">integer</span> <span class="required-text">required</span> | JSON string representing the metadata associated with the files |
| `files` <br /><span class="type-text">array of strings</span> <span class="required-text">required</span> | Array of multipart file objects |
...
https://app.iqm.com/api/api/v3/asset?files=(MULTIPART-FORMDATA)&filesMetadata=[{"attachedFileName":"41455611-74cc-416e-894f-c34640aa6945~IQM-LOGO-RGB.png","originalFileName":"IQM-LOGO-RGB.png"}]
```
