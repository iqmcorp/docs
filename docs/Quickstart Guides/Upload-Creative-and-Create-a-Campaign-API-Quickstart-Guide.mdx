...
The minimum requirements to perform this task are: logging in with authorization credentials, uploading a Creative, and creating a Campaign. Once these steps are accomplished, more can be learned about IQM's API through the [guidelines pages](/docs/Guidelines/).
