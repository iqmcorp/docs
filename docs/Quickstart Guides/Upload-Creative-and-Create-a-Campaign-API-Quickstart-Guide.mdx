...
IQM's PG Campaigns define the individual marketing strategies of your ads in an inventory purchased directly from a specific publisher. 

See [How Do I Set Up a Programmatic Guaranteed (PG) Campaign<ExternalLink />](https://help.iqm.com/en/articles/9613547-how-do-i-set-up-a-programmatic-guaranteed-pg-campaign) for more information.
...
1. A Conversion
   * See [Create a Conversion](/Quickstart%20Guides/Conversion-Quickstart) Tutorial
1. A PG Deal
