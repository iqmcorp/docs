...
This QuickstartGuide will cover how to create a Campaign and upload a Creative. 
...
* [Add New Creative](/Guidelines/Creative-API-Guidelines#add-new-creative)

* [Update Pixel URL](/Guidelines/Creative-API-Guidelines#update-pixel-url)

* [Update Click URL](/Guidelines/Creative-API-Guidelines#update-click-url)
...
For further information see the complete [Campaign Creation API Documentation](/Guidelines/Campaign-API-Guidelines#create-new-pg-campaign).
...
For further information see the complete [Campaign Details API Documentation](/Guidelines/Campaign-API-Guidelines#get-campaign-details-by-id).
