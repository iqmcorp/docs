...
Contextual Audiences have two kinds of data collection periods:
  * **static** - a timeframe set between two dates in the last 180 days and a maximum of a 30 day period
...
This Quickstart Guide will cover how to create a Contextual Audience using both keyword and URLs and each type of data collection period. 
...
<p />You can determine how a Contextual Audience forms groupings by indicating a list of relevant keywords and/or URLs. IQM adds users to the Contextual Audience when they visit a site that features those keywords or URLs. 

The Request Schema table below details the supported fields for creating a Contextual Audience. Review Steps 2a and 2b for detailed instructions on how to perform this action. 
...
You can check on the Audience status after creation to see if its "Ready" or still "Processing". This endpoint will also return various details about the Audience as described in the Response Properties table below. 
