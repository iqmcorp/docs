...
Once a user has created an account, they can perform the login. This API will send OAuth compliant response with an Organization Workspace ID ( <var>owId</var> ) which can be used for any further API communications.
