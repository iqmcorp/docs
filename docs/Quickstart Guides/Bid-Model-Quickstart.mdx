...
Once you have determined your Campaign is eligible, you can pass the <var>campaignId</var> to create Bid Modeling for it. First, create new Bid Model data by specifying **Dimension Priority**, **Bid Multiplier**, and **Spend Ratio** (as outlined in the overview above), and the Spend Ratio Type ID. 
...
### Step 4: Select Dimension and Entity

#### Step 4.1 Get List of Dimensions
...
Once you have determined your Campaign is eligible, you can pass the <var>campaignId</var> to create Bid Modeling for it. 
