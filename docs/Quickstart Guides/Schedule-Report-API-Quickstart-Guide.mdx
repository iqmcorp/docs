...
The minimum requirements to perform this task are: logging in with authorization credentials, and having a campaign started in order to execute reports. Once these steps are accomplished, more can be learned about IQM's API through the [guidelines pages](/docs/Guidelines/).
