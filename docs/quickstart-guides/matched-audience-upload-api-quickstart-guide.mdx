...
| --- | --- |
| Audience subtype ID <br /><span class="type-text">Healthcare vertical</span> | The Audience subtype ID for the Matched Audience being uploaded. See [Audience Subtype List](/guidelines/audience-api/#audience-subtype-list) endpoint for more details. |
| Column IDs for matching | A list of column IDs for matching which correspond to the columns in the file being uploaded. See [Matched Audience Column List](/guidelines/audience-api/#matched-column-list) endpoint for more details. |
| Data format ID | The data format ID corresponds to the type of identifiers being uploaded. See [Data Format List](/guidelines/audience-api/#data-formats-list-for-matched-audience) endpoint for more details. |
| Data partner ID | The data partner ID corresponds to the source of the data being uploaded and is used for reporting purposes. See [Data Partner List](/guidelines/audience-api/#data-partners-list-for-matched-audience) endpoint for more details. |
| Column combination ID <br /><span class="type-text">Political vertical</span> | The column combination ID corresponds to the combination of columns being used for matching. See [Matched Column Combinations](/guidelines/audience-api/#matched-column-combinations) endpoint for more details. |
