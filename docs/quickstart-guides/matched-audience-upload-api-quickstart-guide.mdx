...
<br /><CopyUrl method="POST" url="https://api.iqm.com/api/v2/audience/matched/add" />
<br /><CopyUrl method="GET" url="https://api.iqm.com/api/v2/audience/matched/{matched_audience_Id}" />
...
For further information see the complete [Matched Audience Fields API Documentation](/guidelines/audience-api#column-list-for-matched-audience).
...
For further information see the complete [Matched Audience Upload API Documentation](/guidelines/audience-api#create-matched-audience).
