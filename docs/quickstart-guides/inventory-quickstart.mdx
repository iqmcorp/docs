...
<br /><CopyUrl method="GET" url="https://api.iqm.com/api/v3/inv/groups/api/v3/group/{groupId}/shared/campaigns/list" />
...
<CopyUrl method="GET" url="https://api.iqm.com/api/v3/inv/groups/api/v3/group/{groupId}/shared/campaigns/list" />
