...
<br /><CopyUrl method="POST" url="https://api.iqm.com/api/v3/cmp/inventorygroups/{groupId}/includeExclude" />
...
<CopyUrl method="POST" url="https://api.iqm.com/api/v3/cmp/inventorygroups/{groupId}/includeExclude" />
