...
Optimiize your Inventory with this in-depth Tutorial using IQM's Inventory API.
...
To review all the methods, see the [Create a New Inventory Group](/guidelines/inventory-api#create-a-new-inventory-group) endpoint documentation. 
