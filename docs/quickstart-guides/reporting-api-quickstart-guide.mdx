...
| Headers |  |
| ----  | --- |
| `Authentication` <br /><span class="type-text">string</span> <span class="required-text">required</span> | Authentication bearer token. See [Authentication Guide](/quickstart-guides/authentication-quickstart-guide) |
