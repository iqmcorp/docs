...
For more information see this [Help Center<ExternalLink />](https://help.iqm.com/en/collections/11287049-report-dimensions-and-metrics) article about Conversions and  the complete [Dimension and Metrics Details API Documentation](/guidelines/reports-api#get-dimensions-and-metrics-details).
...
For further information see the complete [Timezone API documentation](/guidelines/master-api#get-timezones).
...
For further information see the complete [Execute Report Data API](/guidelines/reports-api#execute-a-report).
