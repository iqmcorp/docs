...
1. Check Campaign for Eligibility
    * 1.1: Check Insertion Order for Campaign eligibility
...
Once you have determined your Campaign is eligible, you can pass the <var>campaignId</var> and your selected <var>dimensionId</var> to create Bid Modeling. Review the Bid Model tools descriptions in the [About](#about-iqm-bid-modeling) section, the [Bid Modeling Criteria](#bid-modeling-criteria), and the Request Schema table below to create a Bid Model.
