...
See the [Manage Bid Model settings](/guidelines/bid-model-api/#manage-bid-model-settings) endpoint for full documentation. 
...
function manageBidModelling(): Promise<Responses> {
  const options = {
    method: 'PUT',
    url: 'https://api.iqm.com/api/v3/bm/campaigns/{campaignId}/bid-models/{dimensionId}',
    params: {
      path: {
        campaignId: `number`,
        dimensionId: `number`
      ...
      content: {
        "application/json": {
          actionWiseBidModelEntities?: {
            ...
            DELETE?: {
              bidModelDataId?: `array of numbers`,
              bundleIds?: `array of numbers`,
            }
          },
          inclusionExclusionEntityMap?: {
            INCLUDE?: `array of numbers`,
            EXCLUDE?: `array of numbers`,
          },
          baseBid?: `number`,
        }
      }
