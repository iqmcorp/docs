...
This table compares each platform's terminology and entity relationships. The descriptions use IQM's terminology. For full naming and hierarchy details, refer to [IQM Platform Overview](/Getting%20Started/Platform-overview) and [Create Resources<ExternalLink />](https://developers.google.com/display-video/api/guides/managing-line-items/resources#java).
...
<tr>
  ...
  <td rowSpan={3}>IQM: [Workspace API](/Guidelines/Workspace-Guidelines), [IQM Platform Overview](/Getting%20Started/Platform-overview)<p />DV360: [Create Resources<ExternalLink />](https://developers.google.com/display-video/api/guides/managing-line-items/resources#java)  </td>
</tr>
<tr>
...
<tr>
  ...
  <td rowSpan={2}>IQM: [Campaign API](/Guidelines/Campaign-API-Guidelines), [Create a Campaign (Quickstart Guide)](/Quickstart%20Guides/Upload-Creative-and-Create-a-Campaign-API-Quickstart-Guide), [Create a Campaign (Help Center Article)<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign) <p />DV360: [Campaigns<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/Campaigns), [Ad Groups<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/AdGroup)  </td>
</tr>
<tr>
  <td>Campaign</td>
  <td>Insertion Order/Line Item</td>
...
<tr>
  ...
  <td>IQM: [Creative API](/Guidelines/Creative-API-Guidelines)<p />DV360: [Creatives<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/Creative) </td>
</tr>
<tr>
  <td>Audience</td>
  <td>Audience</td>
  <td>The group of people targeted for a Campaign. Audiences are made up of included/excluded demographic data used to optimize targeting. On the IQM platform, this is referred to as the "audience segment" (static lists of segment data are in the Master API); DV360 refers to this as "data groups" or "data elements".</td>
  <td>IQM: [Selecting Your Audiences<ExternalLink />](https://help.iqm.com/en/collections/1387061-selecting-your-audiences), [Master API](/Guidelines/Master-API-Guidelines)  <p />DV360: [Audiences and Targeting<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/AudiencesAndTargeting)</td>
</tr>
<tr>
  <td>Bid Model</td>
...
<tr>
  ...
  <td>IQM: [Reports API](/Guidelines/Reports-API-Guidelines), [Reporting and Analytics<ExternalLink />](https://help.iqm.com/en/collections/1361396-reporting-and-analytics) <p />DV360: [My Reports<ExternalLink />](https://partner.thetradedesk.com/v3/portal/reds/doc/MyReportsGetStarted)</td>
</tr>
<tr>
  <td>Inventory</td>
  <td>Inventory</td>
  <td>An organizational tool that provides advertisers a way to create collections or groups based on ad format, placement type, targeting options, and other properties. IQM has options to bid on Open Exchange Inventory or create Private Marketplace Deals or Programmatic Guaranteed Deals as a way for advertisers to negotiate directly with publishers. DV360 uses their OpenPath product to manage bidding activities.</td>
  <td>IQM: [Inventory API](/Guidelines/Inventory-API-Guide), [Select Inventory <ExternalLink />](https://help.iqm.com/en/collections/2908807-select-inventory) <p />DV360: [Inventory Integrations<ExternalLink />](https://partner.thetradedesk.com/v3/portal/ssp/overview)</td>
</tr>
<tr>
  <td>Conversions</td>
  <td>Tracking Tags</td>
  <td>The string of HTML code that can be placed on your website to measure Conversions. IQM supports client-side (Pixel) and server-side (Postback) Conversions to track visitor activity. DV360 refers to these respectively as Static Tracking Tag or Universal Pixel options.</td>
  <td>IQM: [Conversions API](/Guidelines/Conversion-API-Guidelines), [Choose Your Conversion<ExternalLink />](https://help.iqm.com/en/collections/3219750-choose-your-conversion)<p />DV360: [Tracking Tags<ExternalLink />](https://partner.thetradedesk.com/v3/portal/data/doc/TrackingTagsOverview)</td>
</tr>
<tr>
  <td>Planner</td>
  <td>n/a</td>
