...
<tr>
  ...
  <td rowSpan={3}>IQM: <ul><li>[Workspace API](/Guidelines/Workspace-Guidelines)</li><li> [IQM Platform Overview](/Getting%20Started/Platform-overview)</li></ul><p />DV360: <ul><li>[Resource Hierarchy<ExternalLink />](https://developers.google.com/display-video/api/guides/managing-line-items/resources#resource_hierarchy)</li></ul>  </td>
</tr>
<tr>
...
<tr>
  ...
  <td rowSpan={2}>IQM: <ul><li>[Campaign API](/Guidelines/Campaign-API-Guidelines)</li><li> [Create a Campaign (Quickstart Guide)](/Quickstart%20Guides/Upload-Creative-and-Create-a-Campaign-API-Quickstart-Guide)</li><li> [Create a Campaign (Help Center Article)<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign) </li></ul><p />DV360: <ul><li>[Create Resources<ExternalLink />](https://developers.google.com/display-video/api/guides/managing-line-items/resources#create_resources_2)</li></ul></td>
</tr>
<tr>
  <td>Campaign</td>
...
<tr>
  ...
  <td>IQM: <ul><li>[Selecting Your Audiences<ExternalLink />](https://help.iqm.com/en/collections/1387061-selecting-your-audiences), [Master API](/Guidelines/Master-API-Guidelines)</li></ul>  <p />DV360: <ul><li>[Audiences Types<ExternalLink />](https://developers.google.com/display-video/api/guides/audiences/types)</li><li> [Target Audiences<ExternalLink />](https://developers.google.com/display-video/api/guides/audiences/targeting)</li><li> [Upload Customer Match Audiences<ExternalLink />](https://developers.google.com/display-video/api/guides/audiences/upload-customer-match)</li></ul></td>
</tr>
<tr>
  <td>Bid Model</td>
  ...
  <td>IQM: <ul><li>[Bid Model API](/Guidelines/Bid-Model-API-Guidelines)</li><li> [Campaign Delivery and Optimization<ExternalLink />](https://help.iqm.com/en/collections/3156335-campaign-delivery-and-optimization)</li></ul> <p />DV360: <ul><li>[Implement Custom Bidding<ExternalLink />](https://developers.google.com/display-video/api/guides/managing-line-items/custom-bidding)</li></ul></td>
</tr>
<tr>
  <td>Reports</td>
  <td>Bid Manager</td>
  ...
  <td>IQM: <ul><li>[Reports API](/Guidelines/Reports-API-Guidelines)</li><li> [Reporting and Analytics<ExternalLink />](https://help.iqm.com/en/collections/1361396-reporting-and-analytics)</li></ul> <p />DV360: <ul><li>[Bid Manager API<ExternalLink />](https://developers.google.com/bid-manager)</li><li> [Build and Run Reports<ExternalLink />](https://developers.google.com/bid-manager/guides/build-reports/overview)</li></ul></td>
</tr>
<tr>
  <td>Inventory</td>
  <td>Inventory</td>
  ...
  <td>IQM: <ul><li>[Inventory API](/Guidelines/Inventory-API-Guide)</li><li> [Select Inventory <ExternalLink />](https://help.iqm.com/en/collections/2908807-select-inventory)</li></ul> <p />DV360: <ul><li>[Discover Publishers and Inventory<ExternalLink />](https://support.google.com/displayvideo/answer/6224745?hl=en)</li><li> [Overview of Deals<ExternalLink />](https://support.google.com/displayvideo/answer/7243138?hl=en&ref_topic=6224744&sjid=16394476232875955547-NC)</li></ul></td>
</tr>
<tr>
  <td>Conversions</td>
