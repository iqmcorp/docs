...
<tr>
  ...
  <td rowSpan={2}>IQM: <ul><li>[Campaign API](/Guidelines/Campaign-API-Guidelines)</li><li> [Create a Campaign](/Quickstart%20Guides/Create-a-Campaign-Quickstart) Quickstart Guide</li><li> [Create a Campaign<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign) Help Center article</li></ul><p />DV360: <ul><li>[Create Resources<ExternalLink />](https://developers.google.com/display-video/api/guides/managing-line-items/resources#create_resources_2)</li></ul></td>
</tr>
<tr>
  <td>Campaign</td>
