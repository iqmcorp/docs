...
The Definitions and API Comparison tables highlight the main terminology, actions, and API methods for managing Bid Modeling. Select an endpoint from IQM or DV360 to review that platform's relevant API documentation. By comparing APIs, you can migrate your Bid Modeling workflows from DV360 to IQM.
...
<tr>
  ...
  <td>[<span class="badge bar badge--success">POST</span><span class="path-text">/v3/customBiddingAlgorithms</span>](https://developers.google.com/display-video/api/reference/rest/v3/customBiddingAlgorithms/create)</td>
  <td></td>
</tr>
<tr>
...
<tr>
  ...
  <td>[<span class="badge bar badge--info">PATCH</span><span class="path-text">/v3/customBiddingAlgorithms/\{customBiddingAlgorithm.customBiddingAlgorithmId}</span>](https://developers.google.com/display-video/api/reference/rest/v3/customBiddingAlgorithms/patch)</td>
  <td></td>
</tr>
<tr>
...
<tr>
  ...
  <td>[<span class="badge bar badge--primary">GET</span><span class="path-text">/v3/customBiddingAlgorithms/\{customBiddingAlgorithmId}</span>](https://developers.google.com/display-video/api/reference/rest/v3/customBiddingAlgorithms/get)</td>
...
<tr>
  ...
  <td>[<span class="badge bar badge--success">POST</span><span class="path-text">/v3/customBiddingAlgorithms/\{customBiddingAlgorithmId}/scripts</span>](https://developers.google.com/display-video/api/reference/rest/v3/customBiddingAlgorithms.scripts/create)<br />[<span class="badge bar badge--primary">GET</span><span class="path-text">/v3/customBiddingAlgorithms/\{customBiddingAlgorithmId}:uploadScript</span>](https://developers.google.com/display-video/api/reference/rest/v3/customBiddingAlgorithms/uploadScript)</td>
...
DV360: 
  ...
  * [REST Resource: customBiddingAlgorithms<ExternalLink />](https://developers.google.com/display-video/api/reference/rest/v3/customBiddingAlgorithms)
  * [REST Resource: customBiddingAlgorithms.rules<ExternalLink />](https://developers.google.com/display-video/api/reference/rest/v3/customBiddingAlgorithms.rules)
  * [REST Resource: customBiddingAlgorithms.scripts<ExternalLink />](https://developers.google.com/display-video/api/reference/rest/v3/customBiddingAlgorithms.scripts)
