...
<tr>
  ...
  <td>[<span class="badge bar badge--primary">GET</span><span class="path-text">/v3/inventorySources</span>](https://developers.google.com/display-video/api/reference/rest/v3/inventorySources/list)</td>
...
<tr>
  ...
  <td>[<span class="badge bar badge--primary">GET</span><span class="path-text">/v3/inventorySources/\{inventorySourceId}</span>](https://developers.google.com/display-video/api/reference/rest/v3/inventorySources/get)</td>
  <td></td>
</tr>
<tr>
  <td>Create Deal</td>
  ...
  <td>[<span class="badge bar badge--success">POST</span><span class="path-text">/v3/inventorySources</span>](https://developers.google.com/display-video/api/reference/rest/v3/inventorySources/create)</td>
  <td rowSpan={2}>DV360 endpoint specifies deal type with [<var>InventorySourceProductType</var><ExternalLink />](https://developers.google.com/display-video/api/reference/rest/v3/inventorySources#inventorysourceproducttype) parameter.</td>
</tr>
<tr>
  <td>Update Deal</td>
  ...
  <td>[<span class="badge bar badge--info">PATCH</span><span class="path-text">/v3/inventorySources/\{inventorySource.inventorySourceId}</span>](https://developers.google.com/display-video/api/reference/rest/v3/inventorySources/patch)</td>
</tr>
<tr>
...
<tr>
  ...
  <td>[<span class="badge bar badge--primary">GET</span><span class="path-text">/v3/inventorySourceGroups/\{inventorySourceGroupId}</span>](https://developers.google.com/display-video/api/reference/rest/v3/inventorySourceGroups/get)</td>
...
<tr>
  ...
  <td>[<span class="badge bar badge--success">POST</span><span class="path-text">/v3/inventorySourceGroups</span>](https://developers.google.com/display-video/api/reference/rest/v3/inventorySourceGroups/create)</td>
  <td></td>
</tr>
<tr>
  ...
  <td>[<span class="badge bar badge--info">PATCH</span><span class="path-text">/v3/inventorySourceGroups/\{inventorySourceGroup.inventorySourceGroupId}</span>](https://developers.google.com/display-video/api/reference/rest/v3/inventorySourceGroups/patch)</td>
