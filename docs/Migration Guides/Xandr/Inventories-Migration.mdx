...
<tr>
  ...
  <td>[<span class="badge bar badge--primary">GET</span><span class="path-text">/api/v3/inv/inventories/list</span>](/docs/Guidelines/Inventory-API-Guide#get-list-of-inventories)</td>
...
<tr>
  ...
  <td>n/a</td>
  <td>[<span class="badge bar badge--success">POST</span><span class="path-text">/inventory-list/%5BLIST_ID%5D/item</span>](https://learn.microsoft.com/en-us/xandr/digital-platform-api/inventory-list-service#rest-api)</td>
  <td></td>
</tr>
<tr>
