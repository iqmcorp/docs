...
<tr>
  ...
  <td rowSpan={2}>IQM: [Campaign API](/Guidelines/Campaign-API-Guidelines), [Create a Campaign (Quickstart Guide)](/Quickstart%20Guides/Upload-Creative-and-Create-a-Campaign-API-Quickstart-Guide), [Create a Campaign (Help Center Article)<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign)<p />Xandr: [Insertion Order Service<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/insertion-order-service), [Line Items<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/line-item-service), [Line Item Service - ALI<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/line-item-service---ali)</td>
</tr>
<tr>
  <td>Campaign</td>
