...
<tr>
  ...
  <td rowSpan={3}>IQM: <ul><li>[Workspace API](/Guidelines/Workspace-Guidelines)</li><li>[IQM Platform Overview](/Getting%20Started/Platform-overview)</li></ul><p />Xandr: <ul><li>[Network Relationship Diagram<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/network-relationship-diagram), [Member Service<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/member-service)</li><li> [Publisher Service<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/publisher-service)</li><li> [Advertiser Service<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/advertiser-service)</li></ul></td>
</tr>
<tr>
...
<tr>
  ...
  <td rowSpan={2}>IQM: <ul><li>[Campaign API](/Guidelines/Campaign-API-Guidelines)</li><li> [Create a Campaign (Quickstart Guide)](/Quickstart%20Guides/Upload-Creative-and-Create-a-Campaign-API-Quickstart-Guide)</li><li> [Create a Campaign (Help Center Article)<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign)</li></ul><p />Xandr: <ul><li>[Insertion Order Service<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/insertion-order-service)</li><li> [Line Item Service<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/line-item-service)</li><li> [Line Item Service - ALI<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/line-item-service---ali)</li></ul></td>
</tr>
<tr>
  <td>Campaign</td>
...
<tr>
  ...
  <td>IQM: <ul><li>[Selecting your Audience<ExternalLink />](https://help.iqm.com/en/collections/1387061-selecting-your-audiences), [Master API](/Guidelines/Master-API-Guidelines)</li></ul> <p />Xandr: <ul><li>[Profile Service Overview<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/profile-service)</li></ul></td>
</tr>
<tr>
  <td>Bid Model</td>
  <td>Custom Models</td>
  ...
  <td>IQM: <ul><li>[Bid Model API](/Guidelines/Bid-Model-API-Guidelines)</li><li> [Campaign Delivery and Optimization<ExternalLink />](https://help.iqm.com/en/collections/3156335-campaign-delivery-and-optimization)</li></ul><p />Xandr: <ul><li>[Custom Models<ExternalLink />](https://learn.microsoft.com/en-us/xandr/data-science-toolkit/custom-models)</li></ul></td>
</tr>
<tr>
  <td>Reports</td>
  <td>Reporting</td>
  ...
  <td>IQM: <ul><li>[Reports API](/Guidelines/Reports-API-Guidelines)</li><li> [Reporting and Analytics<ExternalLink />](https://help.iqm.com/en/collections/1361396-reporting-and-analytics)</li></ul><p />Xandr: <ul><li>[Report Service<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/report-service)</li></ul></td>
</tr>
<tr>
  <td>Inventory</td>
  <td>Inventory</td>
  ...
  <td>IQM: <ul><li>[Inventory API](/Guidelines/Inventory-API-Guide)</li><li> [Select Inventory<ExternalLink />](https://help.iqm.com/en/collections/2908807-select-inventory)</li></ul><p />Xandr: <ul><li>[Inventory List Item Service<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/inventory-list-item-service)</li><li> [Deal Service<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/deal-service)</li></ul></td>
</tr>
<tr>
  <td>Conversions</td>
  <td>Conversions</td>
  ...
  <td>IQM: <ul><li>[Conversions API](/Guidelines/Conversion-API-Guidelines)</li><li> [Choose Your Conversion<ExternalLink />](https://help.iqm.com/en/collections/3219750-choose-your-conversion)</li></ul><p />Xandr: <ul><li>[Conversion Pixel Service<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/conversion-pixel-service)</li><li> [Universal Pixel Service<ExternalLink />](https://learn.microsoft.com/en-us/xandr/digital-platform-api/universal-pixel-service)</li></ul></td>
</tr>
<tr>
  <td>Planner</td>
  <td>n/a</td>
  ...
  <td>IQM: <ul><li>[Planner API](/Guidelines/Planner-API-Guidelines)</li><li> [Planner Proposal Overview<ExternalLink />](https://help.iqm.com/en/articles/10104696-planner-proposal-overview) </li></ul></td>
</tr>
</table></center>
