...
<tr>
  ...
  <td rowSpan={2}>IQM: <ul><li>[Campaign API](/Guidelines/Campaign-API-Guidelines)</li><li>[Create a Campaign](/Quickstart%20Guides/Create-a-Campaign-Quickstart) Quickstart Guide</li><li>[Create a Campaign<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign) Help Center article</li></ul> <p />Beeswax: <ul><li>[Line Items<ExternalLink />](https://api-docs.freewheel.tv/beeswax/v2.0/docs/creating-a-line-item)</li></ul> </td>
</tr>
<tr>
  <td>Campaign</td>
  <td>Line Item</td>
