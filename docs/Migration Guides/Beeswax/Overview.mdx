...
<tr>
  ...
  <td>IQM: <ul><li>[Inventory API](/Guidelines/Inventory-API-Guide)</li><li style={{ overflow: "visible" }}> [Ad Inventory and Placements <ExternalLink />](https://help.iqm.com/en/collections/2908807-select-inventory)</li></ul><p />Beeswax: <ul><li>[List Items<ExternalLink />](https://api-docs.freewheel.tv/beeswax/reference/custom-lists-items)</li></ul></td>
</tr>
<tr>
  <td>Conversions</td>
