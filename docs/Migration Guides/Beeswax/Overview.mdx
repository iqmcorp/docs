...
<tr>
  ...
  <td rowSpan={3}>IQM: [Workspace API](/Guidelines/Workspace-Guidelines), [IQM Platform Overview](/Getting%20Started/Platform-overview)<p />Beeswax: [Accounts, Users, Roles, Permissions<ExternalLink />](https://api-docs.freewheel.tv/beeswax/v2.0/accounts-users-roles-permissions)</td>
</tr>
<tr>
...
<tr>
  ...
  <td rowSpan={2}>IQM: [Campaign API](/Guidelines/Campaign-API-Guidelines), [Create a Campaign (Quickstart Guide)](/Quickstart%20Guides/Upload-Creative-and-Create-a-Campaign-API-Quickstart-Guide), [Create a Campaign (Help Center Article)<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign) <p />Beeswax: [Line Items<ExternalLink />](https://api-docs.freewheel.tv/beeswax/v2.0/line-item-configuration) </td>
</tr>
<tr>
  <td>Campaign</td>
  <td>Line Item</td>
...
<tr>
  ...
  <td>IQM: [Creative API](/Guidelines/Creative-API-Guidelines)<p />Beeswax: [Creatives, Creative Assets, Templates, Rules<ExternalLink />](https://api-docs.freewheel.tv/beeswax/creatives-creative-assets-templates-rules)</td>
</tr>
<tr>
  <td>Audience</td>
  <td>Targeting</td>
  ...
  <td>IQM: [Selecting Your Audiences<ExternalLink />](https://help.iqm.com/en/collections/1387061-selecting-your-audiences), [Master API](/Guidelines/Master-API-Guidelines)<p />Beeswax: [Targeting<ExternalLink />](https://api-docs.freewheel.tv/beeswax/v2.0/targeting) </td>
</tr>
<tr>
  <td>Bid Model</td>
  <td>Bid Modifiers</td>
  ...
  <td>IQM: [Bid Model API](/Guidelines/Bid-Model-API-Guidelines), [Campaign Delivery and Optimization<ExternalLink />](https://help.iqm.com/en/collections/3156335-campaign-delivery-and-optimization)<p />Beeswax: [Bid Modifiers<ExternalLink />](https://api-docs.freewheel.tv/beeswax/v2.0/bid-modifiers)</td>
</tr>
<tr>
  <td>Reports</td>
  <td>Reporting</td>
  ...
  <td>IQM: [Reports API](/Guidelines/Reports-API-Guidelines), [Reporting and Analytics<ExternalLink />](https://help.iqm.com/en/collections/1361396-reporting-and-analytics)<p />Beeswax: [Reporting<ExternalLink />](https://api-docs.freewheel.tv/beeswax/v2.0/reporting)</td>
</tr>
<tr>
  <td>Inventory</td>
  <td>Inventory</td>
...
<tr>
  ...
  <td>IQM: [Conversions API](/Guidelines/Conversion-API-Guidelines), [Choose Your Conversion<ExternalLink />](https://help.iqm.com/en/collections/3219750-choose-your-conversion) <p />Beeswax: [Conversion Events<ExternalLink />](https://api-docs.freewheel.tv/beeswax/conversion-events)</td>
</tr>
<tr>
  <td>Planner</td>
  <td>n/a</td>
