...
<tr>
  ...
  <td rowSpan={3}>IQM: <ul><li>[Workspace API](/Guidelines/Workspace-Guidelines)</li> <li>[IQM Platform Overview](/Getting%20Started/Platform-overview)</li></ul> <p />Beeswax: <ul><li>[Accounts, Users, Roles, Permissions<ExternalLink />](https://api-docs.freewheel.tv/beeswax/v2.0/docs/accounts-users-roles-permissions)</li></ul></td>
</tr>
<tr>
...
<tr>
  ...
  <td rowSpan={2}>IQM: <ul><li>[Campaign API](/Guidelines/Campaign-API-Guidelines)</li><li>[Create a Campaign (Quickstart Guide)](/Quickstart%20Guides/Upload-Creative-and-Create-a-Campaign-API-Quickstart-Guide)</li><li>[Create a Campaign (Help Center Article)<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign)</li></ul> <p />Beeswax: <ul><li>[Line Items<ExternalLink />](https://api-docs.freewheel.tv/beeswax/v2.0/docs/creating-a-line-item)</li></ul> </td>
</tr>
<tr>
  <td>Campaign</td>
  <td>Line Item</td>
...
<tr>
  ...
  <td>IQM: <ul><li>[Selecting Your Audiences<ExternalLink />](https://help.iqm.com/en/collections/1387061-selecting-your-audiences)</li><li> [Master API](/Guidelines/Master-API-Guidelines)</li></ul><p />Beeswax: <ul><li>[Targeting<ExternalLink />](https://api-docs.freewheel.tv/beeswax/v2.0/docs/targeting)</li></ul> </td>
</tr>
<tr>
  <td>Bid Model</td>
  <td>Bid Modifiers</td>
  ...
  <td>IQM: <ul><li>[Bid Model API](/Guidelines/Bid-Model-API-Guidelines)</li><li> [Campaign Delivery and Optimization<ExternalLink />](https://help.iqm.com/en/collections/3156335-campaign-delivery-and-optimization)</li></ul><p />Beeswax: <ul><li>[Bid Modifiers<ExternalLink />](https://api-docs.freewheel.tv/beeswax/v2.0/docs/bid-modifiers)</li></ul></td>
</tr>
<tr>
  <td>Reports</td>
  <td>Reporting</td>
  ...
  <td>IQM: <ul><li>[Reports API](/Guidelines/Reports-API-Guidelines)</li><li> [Reporting and Analytics<ExternalLink />](https://help.iqm.com/en/collections/1361396-reporting-and-analytics)</li></ul><p />Beeswax: <ul><li>[Reporting<ExternalLink />](https://api-docs.freewheel.tv/beeswax/v2.0/docs/reporting)</li></ul></td>
</tr>
<tr>
  <td>Inventory</td>
  <td>Inventory</td>
  ...
  <td>IQM: <ul><li>[Inventory API](/Guidelines/Inventory-API-Guide)</li><li> [Select Inventory <ExternalLink />](https://help.iqm.com/en/collections/2908807-select-inventory)</li></ul><p />Beeswax: <ul><li>[List Items<ExternalLink />](https://api-docs.freewheel.tv/beeswax/reference/custom-lists-items)</li></ul></td>
</tr>
<tr>
  <td>Conversions</td>
  ...
  <td>IQM: <ul><li>[Conversions API](/Guidelines/Conversion-API-Guidelines), [Choose Your Conversion<ExternalLink />](https://help.iqm.com/en/collections/3219750-choose-your-conversion)</li></ul> <p />Beeswax: <ul><li>[Conversion Events<ExternalLink />](https://api-docs.freewheel.tv/beeswax/docs/conversion-events)</li></ul></td>
</tr>
<tr>
  <td>Planner</td>
  <td>n/a</td>
