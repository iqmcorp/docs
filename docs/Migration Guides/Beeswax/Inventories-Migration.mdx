...
IQM's [Inventory API](/docs/Guidelines/Inventory-API-Guide) manages inventories, inventory groups, and deals. Beeswax supports the creation of List Items and Custom Lists that can be managed in a similar way to IQM's inventory groups. See the [List Items<ExternalLink />](https://api-docs.freewheel.tv/beeswax/reference/custom-lists-items) page for Beeswax. 
