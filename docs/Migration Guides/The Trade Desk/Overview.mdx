...
This table compares each platform's terminology and entity relationships. The descriptions use IQM's terminology. For full naming and hierarchy details, refer to [IQM Platform Overview](/docs/Getting%20Started/Platform-overview) and [Entity Relationships<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/EntityRelationships).
