...
<tr>
  ...
  <td rowSpan={3}>IQM: <ul><li>[Workspace API](/Guidelines/Workspace-Guidelines)</li><li>[IQM Platform Overview](/Getting%20Started/Platform-overview)</li></ul><p />TTD: <ul><li>[Entity Relationships<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/EntityRelationships)</li></ul>  </td>
</tr>
<tr>
...
<tr>
  ...
  <td rowSpan={2}>IQM: <ul><li>[Campaign API](/Guidelines/Campaign-API-Guidelines)</li><li> [Create a Campaign (Quickstart Guide)](/Quickstart%20Guides/Upload-Creative-and-Create-a-Campaign-API-Quickstart-Guide)</li><li> [Create a Campaign (Help Center Article)<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign)</li></ul> <p />TTD: <ul><li>[Campaigns<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/Campaigns)</li><li> [Ad Groups<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/AdGroup)</li></ul>  </td>
</tr>
<tr>
  <td>Campaign</td>
  <td>Ad Group</td>
...
<tr>
  ...
  <td>IQM: <ul><li>[Audience API](/Guidelines/Audience-API-Guidelines)</li><li> [Selecting Your Audiences<ExternalLink />](https://help.iqm.com/en/collections/1387061-selecting-your-audiences)</li><li>[Master API](/Guidelines/Master-API-Guidelines)</li></ul>  <p />TTD: <ul><li>[Audiences and Targeting<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/AudiencesAndTargeting)</li></ul></td>
</tr>
<tr>
  <td>Bid Model</td>
  <td>Bid Lists</td>
  ...
  <td>IQM: <ul><li>[Bid Model API](/Guidelines/Bid-Model-API-Guidelines)</li><li> [Campaign Delivery and Optimization<ExternalLink />](https://help.iqm.com/en/collections/3156335-campaign-delivery-and-optimization)</li></ul> <p />TTD: <ul><li>[Bid Lists<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/BidList)</li></ul> </td>
</tr>
<tr>
  <td>Reports</td>
  <td>My Reports</td>
  ...
  <td>IQM: <ul><li>[Reports API](/Guidelines/Reports-API-Guidelines)</li><li> [Reporting and Analytics<ExternalLink />](https://help.iqm.com/en/collections/1361396-reporting-and-analytics)</li></ul> <p />TTD: <ul><li>[My Reports<ExternalLink />](https://partner.thetradedesk.com/v3/portal/reds/doc/MyReportsGetStarted)</li></ul></td>
</tr>
<tr>
  <td>Inventory</td>
  <td>Inventory</td>
  ...
  <td>IQM: <ul><li>[Inventory API](/Guidelines/Inventory-API-Guide)</li><li> [Select Inventory <ExternalLink />](https://help.iqm.com/en/collections/2908807-select-inventory)</li></ul> <p />TTD: <ul><li>[Inventory Integrations<ExternalLink />](https://partner.thetradedesk.com/v3/portal/ssp/overview)</li></ul></td>
</tr>
<tr>
  <td>Conversions</td>
  <td>Tracking Tags</td>
  ...
  <td>IQM: <ul><li>[Conversions API](/Guidelines/Conversion-API-Guidelines)</li><li> [Choose Your Conversion<ExternalLink />](https://help.iqm.com/en/collections/3219750-choose-your-conversion)</li></ul><p />TTD: <ul><li>[Tracking Tags<ExternalLink />](https://partner.thetradedesk.com/v3/portal/data/doc/TrackingTagsOverview)</li></ul></td>
</tr>
<tr>
  <td>Planner</td>
  <td>n/a</td>
