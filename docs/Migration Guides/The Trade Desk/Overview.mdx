...
<tr>
  ...
  <td rowSpan={3}>IQM: <ul><li>[Workspace API](/guidelines/workspace-api)</li><li style={{ overflow: "visible" }}>[IQM Platform Overview](/Getting%20Started/Platform-overview)</li></ul><p />TTD: <ul><li>[Entity Relationships<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/EntityRelationships)</li></ul>  </td>
</tr>
<tr>
