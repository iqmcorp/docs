...
This guide will cover and compare the platforms so users can migrate their data from The Trade Desk to IQM's platform. This page will compare the major entities, how they are referred to and what they do. Subsequent pages will compare detailed endpoint-specific API protocols. 
