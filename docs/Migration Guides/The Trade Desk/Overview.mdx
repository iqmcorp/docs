...
<tr>
  ...
  <td rowSpan={2}>IQM: <ul><li>[Campaign API](/Guidelines/Campaign-API-Guidelines)</li><li> [Create a Campaign](/Quickstart%20Guides/Create-a-Campaign-Quickstart) Quickstart Guide</li><li> [Create a Campaign<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign) Help Center article</li></ul> <p />TTD: <ul><li>[Campaigns<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/Campaigns)</li><li> [Ad Groups<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/AdGroup)</li></ul>  </td>
</tr>
<tr>
  <td>Campaign</td>
  <td>Ad Group</td>
