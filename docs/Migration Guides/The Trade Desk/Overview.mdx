...
<tr>
  ...
  <td>IQM: <ul><li>[Audience API](/Guidelines/Audience-API-Guidelines)</li><li style={{ overflow: "visible" }}> [Selecting Your Audiences<ExternalLink />](https://help.iqm.com/en/collections/1387061-selecting-your-audiences)</li><li>[Master API](/Guidelines/Master-API-Guidelines)</li></ul>  <p />TTD: <ul><li>[Audiences and Targeting<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/AudiencesAndTargeting)</li></ul></td>
</tr>
<tr>
  <td>Bid Model</td>
  <td>Bid Lists</td>
