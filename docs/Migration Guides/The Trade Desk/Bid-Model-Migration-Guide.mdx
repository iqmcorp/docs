...
<tr>
  ...
  <td>Bid Line</td>
  <td>A Bid Model settting that adjusts a Campaign's base bid based on specified parameters.</td>
</tr>
<tr>
  <td>Dimension</td>
  <td>Dimension</td>
...
<tr>
  <td>Spend Ratio</td>
  <td rowSpan={2}>Multi-Dimension Bidding</td>
...
TTD: 
  ...
  * [Multi-Dimension Bidding<ExternalLink />](https://partner.thetradedesk.com/v3/portal/api/doc/DimensionalBidding#multi-dimension-bidding)