...
| `priceRangeIds` <br /><span class="type-text">string</span> | Comma separated [Price Range IDs](/Guidelines/Audience-API-Guidelines#price-range-list-for-audience-segment)
| `reachRangeIds` <br /><span class="type-text">string</span> | Comma separated [Reach Range IDs](/Guidelines/Audience-API-Guidelines#reach-range-list-for-audience-segment)
