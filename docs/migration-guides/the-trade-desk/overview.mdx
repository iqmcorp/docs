...
<tr>
  ...
  <td>IQM: <ul><li>[Reports API](/guidelines/reports-api)</li><li style={{ overflow: "visible" }}> [Reporting and Analytics<ExternalLink />](https://help.iqm.com/en/collections/1361396-reporting-and-analytics)</li></ul> <p />TTD: <ul><li>[My Reports<ExternalLink />](https://partner.thetradedesk.com/v3/portal/reds/doc/MyReportsGetStarted)</li></ul></td>
</tr>
<tr>
  <td>Inventory</td>
  <td>Inventory</td>
  ...
  <td>IQM: <ul><li>[Inventory API](/guidelines/inventory-api)</li><li style={{ overflow: "visible" }}> [Ad Inventory and Placements <ExternalLink />](https://help.iqm.com/en/collections/2908807-select-inventory)</li></ul> <p />TTD: <ul><li>[Inventory Integrations<ExternalLink />](https://partner.thetradedesk.com/v3/portal/ssp/overview)</li></ul></td>
</tr>
<tr>
  <td>Conversions</td>
  <td>Tracking Tags</td>
