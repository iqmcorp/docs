...
Migrate a Bid Model from Beeswax to IQM by comparing each platform's API methods for creating and managing Bid Modeling.
...
<tr>
  ...
  <td rowSpan={2}>[<span class="badge bar badge--warning">PUT</span><span class="path-text">/api/v3/bm/campaigns/\{campaignId\}/bid-models/\{dimensionId\}</span>](/guidelines/bid-model-api/#manage-bid-modeling)</td>
