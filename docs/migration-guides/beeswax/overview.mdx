...
<tr>
  ...
  <td rowSpan={2}>IQM: <ul><li>[Campaign API](/guidelines/campaign-api)</li><li style={{ overflow: "visible" }}>[Create a campaign](/quickstart-guides/create-a-campaign-quickstart) </li><li>[Media planning and campaign setup<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign) </li></ul> <p />Beeswax: <ul><li>[Line Items<ExternalLink />](https://api-docs.freewheel.tv/beeswax/v2.0/docs/creating-a-line-item)</li></ul> </td>
</tr>
<tr>
  <td>Campaign</td>
  <td>Line Item</td>
...
<tr>
  ...
  <td>IQM: <ul><li>[Inventory API](/guidelines/inventory-api)</li><li style={{ overflow: "visible" }}> [Ad inventory and placements <ExternalLink />](https://help.iqm.com/en/collections/2908807-select-inventory)</li></ul><p />Beeswax: <ul><li>[List Items<ExternalLink />](https://api-docs.freewheel.tv/advertiser/reference/custom-list-item)</li></ul></td>
</tr>
<tr>
  <td>Conversions</td>
...
<tr>
  <td>Planner</td>
  <td>n/a</td>
  <td>IQM manages proposals in the [Planner API](/guidelines/planner-api) to draft ad strategies that meet Customers' requirements and campaign goals.</td>
</tr>
</table></center>
