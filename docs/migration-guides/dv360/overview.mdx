...
<tr>
  ...
  <td rowSpan={2}>IQM: <ul><li>[Campaign API](/guidelines/campaign-api)</li><li style={{ overflow: "visible" }}> [Create a Campaign](/quickstart-guides/create-a-campaign-quickstart)</li><li> [Media Planning and Campaign Setup<ExternalLink />](https://help.iqm.com/en/collections/1962110-create-a-campaign) </li></ul><p />DV360: <ul><li>[Create Resources<ExternalLink />](https://developers.google.com/display-video/api/guides/managing-line-items/resources#create_resources_2)</li></ul></td>
</tr>
<tr>
  <td>Campaign</td>
